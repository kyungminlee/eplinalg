...
{
  static const char routine_name[] = "BLAS_yspmv_x";
	...
	if (alpha_i[0] == 0.0 && alpha_i[1] == 0.0) {
	  {
	    ...
	    for (matrix_row = 0; matrix_row < n; matrix_row++) {
	      ...
	      {
		tmp2[0] =
		  (EREAL) beta_i[0] * resval[0] -
		  (EREAL) beta_i[1] * resval[1];
		tmp2[1] =
		  (EREAL) beta_i[0] * resval[1] +
		  (EREAL) beta_i[1] * resval[0];
	      }
