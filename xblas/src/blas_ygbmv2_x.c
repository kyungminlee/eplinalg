 ...
 */
{
  static const char routine_name[] = "BLAS_ygbmv2_x";
  ...
  case blas_prec_indigenous:
    {
      ...
      EREAL *y_i = (EREAL *) y;
      const EREAL *a_i = (EREAL *) a;
      const EREAL *head_x_i = (EREAL *) head_x;
      const EREAL *tail_x_i = (EREAL *) tail_x;
	...
	if (trans != blas_conj_trans) {
	  for (j = ra - la; j >= 0; j--) {
	    ...
	    {
	      prod[0] =
		(EREAL) x_elem[0] * a_elem[0] -
		(EREAL) x_elem[1] * a_elem[1];
	      prod[1] =
		(EREAL) x_elem[0] * a_elem[1] +
		(EREAL) x_elem[1] * a_elem[0];
	    }
	...
	{
	  tmp1[0] =
	    (EREAL) sum1[0] * alpha_i[0] - (EREAL) sum1[1] * alpha_i[1];
	  tmp1[1] =
	    (EREAL) sum1[0] * alpha_i[1] + (EREAL) sum1[1] * alpha_i[0];
	}
	{
	  tmp2[0] =
	    (EREAL) sum2[0] * alpha_i[0] - (EREAL) sum2[1] * alpha_i[1];
	  tmp2[1] =
	    (EREAL) sum2[0] * alpha_i[1] + (EREAL) sum2[1] * alpha_i[0];
	}
	...
	{
	  tmp4[0] =
	    (EREAL) beta_i[0] * y_elem[0] - (EREAL) beta_i[1] * y_elem[1];
	  tmp4[1] =
	    (EREAL) beta_i[0] * y_elem[1] + (EREAL) beta_i[1] * y_elem[0];
	}
  ...
  case blas_prec_extra:
    {
      ...
      EREAL head_tmp3[2], tail_tmp3[2];
      EREAL head_tmp4[2], tail_tmp4[2];
      EREAL result[2];
      EREAL head_sum1[2], tail_sum1[2];
      EREAL head_sum2[2], tail_sum2[2];
