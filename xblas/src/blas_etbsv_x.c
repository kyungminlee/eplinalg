...
{
  /* Routine name */
  static const char routine_name[] = "BLAS_etbsv_x";
  ...
  case blas_prec_extra:{
...

	{
	  ...
	  EREAL x_elem;
	  EREAL T_element;	/* temporary variable for an element of matrix T */
	  ...
	  head_x_internal = (EREAL *) blas_malloc(k * sizeof(EREAL));
	  tail_x_internal = (EREAL *) blas_malloc(k * sizeof(EREAL));
