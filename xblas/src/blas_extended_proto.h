...
void BLAS_ddot_e_s(enum blas_conj_type conj, int n, EREAL alpha,
		   const EREAL *x, int incx, EREAL beta,
		   const EREAL *y, int incy, EREAL *r);
...
void BLAS_zdot_y_c(enum blas_conj_type conj, int n, const void *alpha,
		   const void *x, int incx, const void *beta,
		   const void *y, int incy, void *r);
...
void BLAS_ddot_d_s_x(enum blas_conj_type conj, int n, double alpha,
		     ...
		     const float *y, int incy,
		     double *r, enum blas_prec_type prec);
void BLAS_ddot_e_s_x(enum blas_conj_type conj, int n, EREAL alpha,
		     const EREAL *x, int incx, EREAL beta,
		     const EREAL *y, int incy,
		     EREAL *r, enum blas_prec_type prec);
...
void BLAS_zdot_y_c_x(enum blas_conj_type conj, int n, const void *alpha,
		     const void *x, int incx, const void *beta,
		     const void *y, int incy,
		     void *r, enum blas_prec_type prec);
...
void BLAS_yaxpby_e(int n, const void *alpha, const EREAL *x, int incx,
		   const void *beta, void *y, int incy);
...
void BLAS_caxpby_s_x(int n, const void *alpha, const float *x, int incx,
		     const void *beta, void *y,
		     int incy, enum blas_prec_type prec);
void BLAS_yaxpby_e_x(int n, const void *alpha, const EREAL *x, int incx,
		     const void *beta, void *y,
		     int incy, enum blas_prec_type prec);
...
void BLAS_dwaxpby_d_s(int n, double alpha, const double *x, int incx,
		      ...
		      int incw);
void BLAS_dwaxpby_e_s(int n, EREAL alpha, const EREAL *x, int incx,
...
void BLAS_zwaxpby_z_c(int n, const void *alpha, const void *x, int incx,
		      ...
		      int incw);
void BLAS_zwaxpby_y_c(int n, const void *alpha, const void *x, int incx,
		      const void *beta, const void *y, int incy, void *w,
		      int incw);
...
void BLAS_dwaxpby_d_s_x(int n, double alpha, const double *x, int incx,
			double beta, const float *y, int incy, double *w,
			int incw, enum blas_prec_type prec);
void BLAS_dwaxpby_e_s_x(int n, EREAL alpha, const EREAL *x, int incx,
			EREAL beta, const EREAL *y, int incy, EREAL *w,
			int incw, enum blas_prec_type prec);
...
void BLAS_zwaxpby_z_c_x(int n, const void *alpha, const void *x, int incx,
			const void *beta, const void *y, int incy, void *w,
			int incw, enum blas_prec_type prec);
void BLAS_zwaxpby_y_c_x(int n, const void *alpha, const void *x, int incx,
			const void *beta, const void *y, int incy, void *w,
			int incw, enum blas_prec_type prec);
...
void BLAS_dgemv_d_s(enum blas_order_type order, enum blas_trans_type trans,
		    ...
		    int incy);
void BLAS_dgemv_e_s(enum blas_order_type order, enum blas_trans_type trans,
...
void BLAS_zgemv_z_c(enum blas_order_type order, enum blas_trans_type trans,
		    ...
		    int incy);
void BLAS_zgemv_y_c(enum blas_order_type order, enum blas_trans_type trans,
		    int m, int n, const void *alpha, const void *a, int lda,
		    const void *x, int incx, const void *beta, void *y,
		    int incy);
...
void BLAS_cgemv_x(enum blas_order_type order, enum blas_trans_type trans,
		  ...
		  const void *x, int incx, const void *beta, void *y,
		  int incy, enum blas_prec_type prec);
void BLAS_ygemv_x(enum blas_order_type order, enum blas_trans_type trans,
		  int m, int n, const void *alpha, const void *a, int lda,
		  const void *x, int incx, const void *beta, void *y,
		  int incy, enum blas_prec_type prec);
...
void BLAS_dgemv_d_s_x(enum blas_order_type order, enum blas_trans_type trans,
		      ...
		      const float *x, int incx, double beta, double *y,
		      int incy, enum blas_prec_type prec);
void BLAS_dgemv_e_s_x(enum blas_order_type order, enum blas_trans_type trans,
		      int m, int n, EREAL alpha, const EREAL *a, int lda,
		      const EREAL *x, int incx, EREAL beta, EREAL *y,
		      int incy, enum blas_prec_type prec);
...
void BLAS_zgemv_z_c_x(enum blas_order_type order, enum blas_trans_type trans,
		      ...
		      const void *x, int incx, const void *beta, void *y,
		      int incy, enum blas_prec_type prec);
void BLAS_zgemv_y_c_x(enum blas_order_type order, enum blas_trans_type trans,
		      int m, int n, const void *alpha, const void *a, int lda,
		      const void *x, int incx, const void *beta, void *y,
		      int incy, enum blas_prec_type prec);
...
void BLAS_dge_sum_mv_d_s(enum blas_order_type order, int m, int n,
			 ...
			 double *y, int incy);
void BLAS_dge_sum_mv_e_s(enum blas_order_type order, int m, int n,
...
void BLAS_zge_sum_mv_z_c(enum blas_order_type order, int m, int n,
			 ...
			 void *y, int incy);
void BLAS_zge_sum_mv_y_c(enum blas_order_type order, int m, int n,
			 const void *alpha, const void *a, int lda,
			 const void *x, int incx,
			 const void *beta, const void *b, int ldb,
			 void *y, int incy);
...
void BLAS_cge_sum_mv_x(enum blas_order_type order, int m, int n,
		       ...
		       const void *beta, const void *b, int ldb,
		       void *y, int incy, enum blas_prec_type prec);
void BLAS_yge_sum_mv_x(enum blas_order_type order, int m, int n,
		       const void *alpha, const void *a, int lda,
		       const void *x, int incx,
		       const void *beta, const void *b, int ldb,
		       void *y, int incy, enum blas_prec_type prec);
...
void BLAS_dge_sum_mv_d_s_x(enum blas_order_type order, int m, int n,
			   ...
			   double beta, const double *b, int ldb,
			   double *y, int incy, enum blas_prec_type prec);
void BLAS_dge_sum_mv_e_s_x(enum blas_order_type order, int m, int n,
			   EREAL alpha, const EREAL *a, int lda,
			   const EREAL *x, int incx,
			   EREAL beta, const EREAL *b, int ldb,
			   EREAL *y, int incy, enum blas_prec_type prec);
...
void BLAS_zge_sum_mv_z_c_x(enum blas_order_type order, int m, int n,
			   ...
			   const void *beta, const void *b, int ldb,
			   void *y, int incy, enum blas_prec_type prec);
void BLAS_zge_sum_mv_y_c_x(enum blas_order_type order, int m, int n,
			   const void *alpha, const void *a, int lda,
			   const void *x, int incx,
			   const void *beta, const void *b, int ldb,
			   void *y, int incy, enum blas_prec_type prec);
...
void BLAS_dgbmv_d_s(enum blas_order_type order, enum blas_trans_type trans,
		    ...
		    double beta, double *y, int incy);
void BLAS_dgbmv_e_s(enum blas_order_type order, enum blas_trans_type trans,
...
void BLAS_zgbmv_z_c(enum blas_order_type order, enum blas_trans_type trans,
		    ...
		    const void *beta, void *y, int incy);
void BLAS_zgbmv_y_c(enum blas_order_type order, enum blas_trans_type trans,
		    int m, int n, int kl, int ku, const void *alpha,
		    const void *a, int lda, const void *x, int incx,
		    const void *beta, void *y, int incy);
...
void BLAS_ygbmv_x(enum blas_order_type order, enum blas_trans_type trans,
		  int m, int n, int kl, int ku, const void *alpha,
		  const void *a, int lda, const void *x, int incx,
		  const void *beta, void *y, int incy,
		  enum blas_prec_type prec);
...
void BLAS_dgbmv_d_s_x(enum blas_order_type order, enum blas_trans_type trans,
		      ...
		      double beta, double *y, int incy,
		      enum blas_prec_type prec);
void BLAS_dgbmv_e_s_x(enum blas_order_type order, enum blas_trans_type trans,
		      int m, int n, int kl, int ku, EREAL alpha,
		      const EREAL *a, int lda, const EREAL *x, int incx,
		      EREAL beta, EREAL *y, int incy,
		      enum blas_prec_type prec);
...
void BLAS_zgbmv_z_c_x(enum blas_order_type order, enum blas_trans_type trans,
		      ...
		      const void *beta, void *y, int incy,
		      enum blas_prec_type prec);
void BLAS_zgbmv_y_c_x(enum blas_order_type order, enum blas_trans_type trans,
		      int m, int n, int kl, int ku, const void *alpha,
		      const void *a, int lda, const void *x, int incx,
		      const void *beta, void *y, int incy,
		      enum blas_prec_type prec);
...
void BLAS_dsymv_d_s(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    const float *x, int incx, double beta,
		    double *y, int incy);
void BLAS_dsymv_e_s(enum blas_order_type order, enum blas_uplo_type uplo,
...
void BLAS_zsymv_z_c(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    const void *x, int incx, const void *beta,
		    void *y, int incy);
void BLAS_zsymv_y_c(enum blas_order_type order, enum blas_uplo_type uplo,
		    int n, const void *alpha, const void *a, int lda,
		    const void *x, int incx, const void *beta,
		    void *y, int incy);
...
void BLAS_csymv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  const void *x, int incx, const void *beta,
		  void *y, int incy, enum blas_prec_type prec);
void BLAS_ysymv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  int n, const void *alpha, const void *a, int lda,
		  const void *x, int incx, const void *beta,
		  void *y, int incy, enum blas_prec_type prec);
...
void BLAS_dsymv_d_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      ...
		      const float *x, int incx, double beta,
		      double *y, int incy, enum blas_prec_type prec);
void BLAS_dsymv_e_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      int n, EREAL alpha, const EREAL *a, int lda,
		      const EREAL *x, int incx, EREAL beta,
		      EREAL *y, int incy, enum blas_prec_type prec);
...
void BLAS_zsymv_z_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      ...
		      const void *x, int incx, const void *beta,
		      void *y, int incy, enum blas_prec_type prec);
void BLAS_zsymv_y_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      int n, const void *alpha, const void *a, int lda,
		      const void *x, int incx, const void *beta,
		      void *y, int incy, enum blas_prec_type prec);
...
void BLAS_dspmv_d_s(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    const float *x, int incx, double beta,
		    double *y, int incy);
void BLAS_dspmv_e_s(enum blas_order_type order, enum blas_uplo_type uplo,
...
void BLAS_zspmv_z_c(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    const void *x, int incx, const void *beta,
		    void *y, int incy);
void BLAS_zspmv_y_c(enum blas_order_type order, enum blas_uplo_type uplo,
		    int n, const void *alpha, const void *ap,
		    const void *x, int incx, const void *beta,
		    void *y, int incy);
...
void BLAS_cspmv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  const void *x, int incx, const void *beta,
		  void *y, int incy, enum blas_prec_type prec);
void BLAS_yspmv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  int n, const void *alpha, const void *ap,
		  const void *x, int incx, const void *beta,
		  void *y, int incy, enum blas_prec_type prec);
...
void BLAS_dspmv_d_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      ...
		      const float *x, int incx, double beta,
		      double *y, int incy, enum blas_prec_type prec);
void BLAS_dspmv_e_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      int n, EREAL alpha, const EREAL *ap,
		      const EREAL *x, int incx, EREAL beta,
		      EREAL *y, int incy, enum blas_prec_type prec);
...
void BLAS_zspmv_z_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      ...
		      const void *x, int incx, const void *beta,
		      void *y, int incy, enum blas_prec_type prec);
void BLAS_zspmv_y_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      int n, const void *alpha, const void *ap,
		      const void *x, int incx, const void *beta,
		      void *y, int incy, enum blas_prec_type prec);
...
void BLAS_dsbmv_d_s(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    const float *x, int incx, double beta,
		    double *y, int incy);
void BLAS_dsbmv_e_s(enum blas_order_type order, enum blas_uplo_type uplo,
...
void BLAS_zsbmv_z_c(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    const void *x, int incx, const void *beta,
		    void *y, int incy);
void BLAS_zsbmv_y_c(enum blas_order_type order, enum blas_uplo_type uplo,
		    int n, int k, const void *alpha, const void *a, int lda,
		    const void *x, int incx, const void *beta,
		    void *y, int incy);
...
void BLAS_ssbmv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  const float *x, int incx, float beta,
		  float *y, int incy, enum blas_prec_type prec);
void BLAS_esbmv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  int n, int k, EREAL alpha, const EREAL *a, int lda,
		  const EREAL *x, int incx, EREAL beta,
		  EREAL *y, int incy, enum blas_prec_type prec);
...
void BLAS_csbmv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  const void *x, int incx, const void *beta,
		  void *y, int incy, enum blas_prec_type prec);
void BLAS_ysbmv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  int n, int k, const void *alpha, const void *a, int lda,
		  const void *x, int incx, const void *beta,
		  void *y, int incy, enum blas_prec_type prec);
...
void BLAS_dsbmv_d_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      ...
		      const float *x, int incx, double beta,
		      double *y, int incy, enum blas_prec_type prec);
void BLAS_dsbmv_e_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      int n, int k, EREAL alpha, const EREAL *a, int lda,
		      const EREAL *x, int incx, EREAL beta,
		      EREAL *y, int incy, enum blas_prec_type prec);
...
void BLAS_zsbmv_z_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      ...
		      const void *x, int incx, const void *beta,
		      void *y, int incy, enum blas_prec_type prec);
void BLAS_zsbmv_y_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      int n, int k, const void *alpha, const void *a, int lda,
		      const void *x, int incx, const void *beta,
		      void *y, int incy, enum blas_prec_type prec);
...
void BLAS_zhemv_z_c(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    const void *x, int incx, const void *beta,
		    void *y, int incy);
void BLAS_zhemv_y_c(enum blas_order_type order, enum blas_uplo_type uplo,
		    int n, const void *alpha, const void *a, int lda,
		    const void *x, int incx, const void *beta,
		    void *y, int incy);
...
void BLAS_chemv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  const void *x, int incx, const void *beta,
		  void *y, int incy, enum blas_prec_type prec);
void BLAS_yhemv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  int n, const void *alpha, const void *a, int lda,
		  const void *x, int incx, const void *beta,
		  void *y, int incy, enum blas_prec_type prec);
...
void BLAS_zhemv_z_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      ...
		      const void *x, int incx, const void *beta,
		      void *y, int incy, enum blas_prec_type prec);
void BLAS_zhemv_y_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      int n, const void *alpha, const void *a, int lda,
		      const void *x, int incx, const void *beta,
		      void *y, int incy, enum blas_prec_type prec);
...
void BLAS_zhpmv_z_c(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    const void *x, int incx, const void *beta, void *y,
		    int incy);
void BLAS_zhpmv_y_c(enum blas_order_type order, enum blas_uplo_type uplo,
		    int n, const void *alpha, const void *ap,
		    const void *x, int incx, const void *beta, void *y,
		    int incy);
...
void BLAS_zhpmv_z_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      ...
		      const void *x, int incx, const void *beta, void *y,
		      int incy, enum blas_prec_type prec);
void BLAS_zhpmv_y_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		      int n, const void *alpha, const void *ap,
		      const void *x, int incx, const void *beta, void *y,
		      int incy, enum blas_prec_type prec);
...
void BLAS_zhbmv_z_c(enum blas_order_type order,
		    ...
		    const void *x, int incx, const void *beta,
		    void *y, int incy);
void BLAS_zhbmv_y_c(enum blas_order_type order,
		    enum blas_uplo_type uplo, int n, int k,
		    const void *alpha, const void *a, int lda,
		    const void *x, int incx, const void *beta,
		    void *y, int incy);
...
void BLAS_chbmv_x(enum blas_order_type order,
		  ...
		  const void *x, int incx, const void *beta,
		  void *y, int incy, enum blas_prec_type prec);
void BLAS_yhbmv_x(enum blas_order_type order,
		  enum blas_uplo_type uplo, int n, int k,
		  const void *alpha, const void *a, int lda,
		  const void *x, int incx, const void *beta,
		  void *y, int incy, enum blas_prec_type prec);
...
void BLAS_zhbmv_z_c_x(enum blas_order_type order,
		      ...
		      const void *x, int incx, const void *beta,
		      void *y, int incy, enum blas_prec_type prec);
void BLAS_zhbmv_y_c_x(enum blas_order_type order,
		      enum blas_uplo_type uplo, int n, int k,
		      const void *alpha, const void *a, int lda,
		      const void *x, int incx, const void *beta,
		      void *y, int incy, enum blas_prec_type prec);
...
void BLAS_ctrmv_s(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  void *x, int incx);
void BLAS_ytrmv_e(enum blas_order_type order, enum blas_uplo_type uplo,
		  enum blas_trans_type trans, enum blas_diag_type diag, int n,
		  const void *alpha, const EREAL *T, int ldt,
		  void *x, int incx);
...
void BLAS_ytrmv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  enum blas_trans_type trans, enum blas_diag_type diag, int n,
		  const void *alpha, const void *T, int ldt,
		  void *x, int incx, enum blas_prec_type prec);
...
void BLAS_ctrmv_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    void *x, int incx, enum blas_prec_type prec);
void BLAS_ytrmv_e_x(enum blas_order_type order, enum blas_uplo_type uplo,
		    enum blas_trans_type trans, enum blas_diag_type diag,
		    int n, const void *alpha, const EREAL *T, int ldt,
		    void *x, int incx, enum blas_prec_type prec);
...
void BLAS_ctpmv_s(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  void *x, int incx);
void BLAS_ytpmv_e(enum blas_order_type order, enum blas_uplo_type uplo,
		  enum blas_trans_type trans, enum blas_diag_type diag,
		  int n, const void *alpha, const EREAL *tp,
		  void *x, int incx);
...
void BLAS_ctpmv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  int n, const void *alpha, const void *tp,
		  void *x, int incx, enum blas_prec_type prec);
void BLAS_ytpmv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  enum blas_trans_type trans, enum blas_diag_type diag,
		  int n, const void *alpha, const void *tp,
		  void *x, int incx, enum blas_prec_type prec);
...
void BLAS_ctpmv_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    int n, const void *alpha, const float *tp,
		    void *x, int incx, enum blas_prec_type prec);
void BLAS_ytpmv_e_x(enum blas_order_type order, enum blas_uplo_type uplo,
		    enum blas_trans_type trans, enum blas_diag_type diag,
		    int n, const void *alpha, const EREAL *tp,
		    void *x, int incx, enum blas_prec_type prec);
...
void BLAS_ctrsv_s(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  int n, const void *alpha, const float *T, int ldt,
		  void *x, int incx);
void BLAS_ytrsv_e(enum blas_order_type order, enum blas_uplo_type uplo,
		  enum blas_trans_type trans, enum blas_diag_type diag,
		  int n, const void *alpha, const EREAL *T, int ldt,
		  void *x, int incx);
...
void BLAS_ctrsv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  int n, const void *alpha, const void *T, int ldt,
		  void *x, int incx, enum blas_prec_type prec);
void BLAS_ytrsv_x(enum blas_order_type order, enum blas_uplo_type uplo,
		  enum blas_trans_type trans, enum blas_diag_type diag,
		  int n, const void *alpha, const void *T, int ldt,
		  void *x, int incx, enum blas_prec_type prec);
...
void BLAS_ctrsv_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    int n, const void *alpha, const float *T, int ldt,
		    void *x, int incx, enum blas_prec_type prec);
void BLAS_ytrsv_e_x(enum blas_order_type order, enum blas_uplo_type uplo,
		    enum blas_trans_type trans, enum blas_diag_type diag,
		    int n, const void *alpha, const EREAL *T, int ldt,
		    void *x, int incx, enum blas_prec_type prec);
...
void BLAS_ctbsv_s(enum blas_order_type order, enum blas_uplo_type uplo,
		  ...
		  void *x, int incx);
void BLAS_ytbsv_e(enum blas_order_type order, enum blas_uplo_type uplo,
		  enum blas_trans_type trans, enum blas_diag_type diag,
		  int n, int k, const void *alpha, const EREAL *t, int ldt,
		  void *x, int incx);
...
void BLAS_ctbsv_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		    ...
		    int n, int k, const void *alpha, const float *t, int ldt,
		    void *x, int incx, enum blas_prec_type prec);
void BLAS_ytbsv_e_x(enum blas_order_type order, enum blas_uplo_type uplo,
		    enum blas_trans_type trans, enum blas_diag_type diag,
		    int n, int k, const void *alpha, const EREAL *t, int ldt,
		    void *x, int incx, enum blas_prec_type prec);
...
void BLAS_dgemm_e_s(enum blas_order_type order, enum blas_trans_type transa,
		    enum blas_trans_type transb, int m, int n, int k,
...
void BLAS_zgemm_y_c(enum blas_order_type order, enum blas_trans_type transa,
		    enum blas_trans_type transb, int m, int n, int k,
		    const void *alpha, const void *a, int lda, const void *b,
		    int ldb, const void *beta, void *c, int ldc);
...
void BLAS_cgemm_x(enum blas_order_type order, enum blas_trans_type transa,
		  ...
		  int ldb, const void *beta, void *c, int ldc,
		  enum blas_prec_type prec);
void BLAS_ygemm_x(enum blas_order_type order, enum blas_trans_type transa,
		  enum blas_trans_type transb, int m, int n, int k,
		  const void *alpha, const void *a, int lda, const void *b,
		  int ldb, const void *beta, void *c, int ldc,
		  enum blas_prec_type prec);
...
void BLAS_dgemm_d_s_x(enum blas_order_type order, enum blas_trans_type transa,
		      ...
		      int ldb, double beta, double *c, int ldc,
		      enum blas_prec_type prec);
void BLAS_dgemm_e_s_x(enum blas_order_type order, enum blas_trans_type transa,
		      enum blas_trans_type transb, int m, int n, int k,
		      EREAL alpha, const EREAL *a, int lda, const EREAL *b,
		      int ldb, EREAL beta, EREAL *c, int ldc,
		      enum blas_prec_type prec);
...
void BLAS_zgemm_y_c_x(enum blas_order_type order, enum blas_trans_type transa,
		      enum blas_trans_type transb, int m, int n, int k,
		      const void *alpha, const void *a, int lda,
		      const void *b, int ldb, const void *beta, void *c,
		      int ldc, enum blas_prec_type prec);
...
void BLAS_dsymm_e_s(enum blas_order_type order, enum blas_side_type side,
		    enum blas_uplo_type uplo, int m, int n,
		    EREAL alpha, const EREAL *a, int lda,
		    const EREAL *b, int ldb, EREAL beta, EREAL *c, int ldc);
...
void BLAS_zsymm_z_c(enum blas_order_type order, enum blas_side_type side,
		    ...
		    void *c, int ldc);
void BLAS_zsymm_y_c(enum blas_order_type order, enum blas_side_type side,
		    enum blas_uplo_type uplo, int m, int n,
		    const void *alpha, const void *a, int lda,
		    const void *b, int ldb, const void *beta,
		    void *c, int ldc);
...
void BLAS_ysymm_x(enum blas_order_type order, enum blas_side_type side,
		  enum blas_uplo_type uplo, int m, int n,
		  const void *alpha, const void *a, int lda,
		  const void *b, int ldb, const void *beta,
		  void *c, int ldc, enum blas_prec_type prec);
...
void BLAS_dsymm_d_s_x(enum blas_order_type order, enum blas_side_type side,
		      ...
		      double *c, int ldc, enum blas_prec_type prec);
void BLAS_dsymm_e_s_x(enum blas_order_type order, enum blas_side_type side,
		      enum blas_uplo_type uplo, int m, int n,
		      EREAL alpha, const EREAL *a, int lda,
		      const EREAL *b, int ldb, EREAL beta,
		      EREAL *c, int ldc, enum blas_prec_type prec);
...
void BLAS_zsymm_z_c_x(enum blas_order_type order, enum blas_side_type side,
		      ...
		      const void *b, int ldb, const void *beta,
		      void *c, int ldc, enum blas_prec_type prec);
void BLAS_zsymm_y_c_x(enum blas_order_type order, enum blas_side_type side,
		      enum blas_uplo_type uplo, int m, int n,
		      const void *alpha, const void *a, int lda,
		      const void *b, int ldb, const void *beta,
		      void *c, int ldc, enum blas_prec_type prec);
...
void BLAS_zhemm_z_c(enum blas_order_type order, enum blas_side_type side,
		    ...
		    const void *b, int ldb, const void *beta,
		    void *c, int ldc);
void BLAS_zhemm_y_c(enum blas_order_type order, enum blas_side_type side,
		    enum blas_uplo_type uplo, int m, int n,
		    const void *alpha, const void *a, int lda,
		    const void *b, int ldb, const void *beta,
		    void *c, int ldc);
...
void BLAS_chemm_x(enum blas_order_type order, enum blas_side_type side,
		  ...
		  const void *b, int ldb, const void *beta,
		  void *c, int ldc, enum blas_prec_type prec);
void BLAS_yhemm_x(enum blas_order_type order, enum blas_side_type side,
		  enum blas_uplo_type uplo, int m, int n,
		  const void *alpha, const void *a, int lda,
		  const void *b, int ldb, const void *beta,
		  void *c, int ldc, enum blas_prec_type prec);
...
void BLAS_zhemm_z_c_x(enum blas_order_type order, enum blas_side_type side,
		      ...
		      const void *b, int ldb, const void *beta,
		      void *c, int ldc, enum blas_prec_type prec);
void BLAS_zhemm_y_c_x(enum blas_order_type order, enum blas_side_type side,
		      enum blas_uplo_type uplo, int m, int n,
		      const void *alpha, const void *a, int lda,
		      const void *b, int ldb, const void *beta,
		      void *c, int ldc, enum blas_prec_type prec);
...
void BLAS_dgemv2_d_s(enum blas_order_type order, enum blas_trans_type trans,
		     ...
		     double beta, double *y, int incy);
void BLAS_dgemv2_e_s(enum blas_order_type order, enum blas_trans_type trans,
		     int m, int n, EREAL alpha, const EREAL *a, int lda,
...
void BLAS_zgemv2_z_c(enum blas_order_type order, enum blas_trans_type trans,
		     ...
		     const void *beta, void *y, int incy);
void BLAS_zgemv2_y_c(enum blas_order_type order, enum blas_trans_type trans,
		     int m, int n, const void *alpha, const void *a, int lda,
		     const void *head_x, const void *tail_x, int incx,
		     const void *beta, void *y, int incy);
...
void BLAS_cgemv2_x(enum blas_order_type order, enum blas_trans_type trans,
		   ...
		   const void *beta, void *y, int incy,
		   enum blas_prec_type prec);
void BLAS_ygemv2_x(enum blas_order_type order, enum blas_trans_type trans,
		   int m, int n, const void *alpha, const void *a, int lda,
		   const void *head_x, const void *tail_x, int incx,
		   const void *beta, void *y, int incy,
		   enum blas_prec_type prec);
...
void BLAS_dgemv2_d_s_x(enum blas_order_type order, enum blas_trans_type trans,
		       ...
		       double beta, double *y, int incy,
		       enum blas_prec_type prec);
void BLAS_dgemv2_e_s_x(enum blas_order_type order, enum blas_trans_type trans,
		       int m, int n, EREAL alpha, const EREAL *a, int lda,
		       const EREAL *head_x, const EREAL *tail_x, int incx,
		       EREAL beta, EREAL *y, int incy,
		       enum blas_prec_type prec);
...
void BLAS_zgemv2_z_c_x(enum blas_order_type order, enum blas_trans_type trans,
		       ...
		       int incx, const void *beta, void *y, int incy,
		       enum blas_prec_type prec);
void BLAS_zgemv2_y_c_x(enum blas_order_type order, enum blas_trans_type trans,
		       int m, int n, const void *alpha, const void *a,
		       int lda, const void *head_x, const void *tail_x,
		       int incx, const void *beta, void *y, int incy,
		       enum blas_prec_type prec);
...
void BLAS_dsymv2_d_s(enum blas_order_type order, enum blas_uplo_type uplo,
		     ...
		     double beta, double *y, int incy);
void BLAS_dsymv2_e_s(enum blas_order_type order, enum blas_uplo_type uplo,
		     int n, EREAL alpha, const EREAL *a, int lda,
...
void BLAS_zsymv2_z_c(enum blas_order_type order, enum blas_uplo_type uplo,
		     ...
		     const void *beta, void *y, int incy);
void BLAS_zsymv2_y_c(enum blas_order_type order, enum blas_uplo_type uplo,
		     int n, const void *alpha, const void *a, int lda,
		     const void *x_head, const void *x_tail, int incx,
		     const void *beta, void *y, int incy);
...
void BLAS_csymv2_x(enum blas_order_type order, enum blas_uplo_type uplo,
		   ...
		   const void *beta, void *y, int incy,
		   enum blas_prec_type prec);
void BLAS_ysymv2_x(enum blas_order_type order, enum blas_uplo_type uplo,
		   int n, const void *alpha, const void *a, int lda,
		   const void *x_head, const void *x_tail, int incx,
		   const void *beta, void *y, int incy,
		   enum blas_prec_type prec);
...
void BLAS_dsymv2_d_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		       ...
		       double beta, double *y, int incy,
		       enum blas_prec_type prec);
void BLAS_dsymv2_e_s_x(enum blas_order_type order, enum blas_uplo_type uplo,
		       int n, EREAL alpha, const EREAL *a, int lda,
		       const EREAL *x_head, const EREAL *x_tail, int incx,
		       EREAL beta, EREAL *y, int incy,
		       enum blas_prec_type prec);
...
void BLAS_zsymv2_z_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		       ...
		       const void *beta, void *y, int incy,
		       enum blas_prec_type prec);
void BLAS_zsymv2_y_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		       int n, const void *alpha, const void *a, int lda,
		       const void *x_head, const void *x_tail, int incx,
		       const void *beta, void *y, int incy,
		       enum blas_prec_type prec);
...
void BLAS_zhemv2_y_c(enum blas_order_type order, enum blas_uplo_type uplo,
		     int n, const void *alpha, const void *a, int lda,
		     const void *x_head, const void *x_tail, int incx,
		     const void *beta, const void *y, int incy);
...
void BLAS_chemv2_x(enum blas_order_type order, enum blas_uplo_type uplo,
		   ...
		   const void *beta, const void *y, int incy,
		   enum blas_prec_type prec);
void BLAS_yhemv2_x(enum blas_order_type order, enum blas_uplo_type uplo,
		   int n, const void *alpha, const void *a, int lda,
		   const void *x_head, const void *x_tail, int incx,
		   const void *beta, const void *y, int incy,
		   enum blas_prec_type prec);
...
void BLAS_zhemv2_z_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		       ...
		       const void *beta, const void *y, int incy,
		       enum blas_prec_type prec);
void BLAS_zhemv2_y_c_x(enum blas_order_type order, enum blas_uplo_type uplo,
		       int n, const void *alpha, const void *a, int lda,
		       const void *x_head, const void *x_tail, int incx,
		       const void *beta, const void *y, int incy,
		       enum blas_prec_type prec);
...
void BLAS_dgbmv2_d_s(enum blas_order_type order, enum blas_trans_type trans,
		     ...
		     double *y, int incy);
void BLAS_dgbmv2_e_s(enum blas_order_type order, enum blas_trans_type trans,
		     int m, int n, int kl, int ku, EREAL alpha,
...
void BLAS_zgbmv2_z_c(enum blas_order_type order, enum blas_trans_type trans,
		     ...
		     void *y, int incy);
void BLAS_zgbmv2_y_c(enum blas_order_type order, enum blas_trans_type trans,
		     int m, int n, int kl, int ku, const void *alpha,
		     const void *a, int lda, const void *head_x,
		     const void *tail_x, int incx, const void *beta,
		     void *y, int incy);
...
void BLAS_cgbmv2_x(enum blas_order_type order, enum blas_trans_type trans,
		   ...
		   const void *tail_x, int incx, const void *beta,
		   void *y, int incy, enum blas_prec_type prec);
void BLAS_ygbmv2_x(enum blas_order_type order, enum blas_trans_type trans,
		   int m, int n, int kl, int ku, const void *alpha,
		   const void *a, int lda, const void *head_x,
		   const void *tail_x, int incx, const void *beta,
		   void *y, int incy, enum blas_prec_type prec);
...
void BLAS_dgbmv2_d_s_x(enum blas_order_type order, enum blas_trans_type trans,
		       ...
		       const float *tail_x, int incx, double beta,
		       double *y, int incy, enum blas_prec_type prec);
void BLAS_dgbmv2_e_s_x(enum blas_order_type order, enum blas_trans_type trans,
		       int m, int n, int kl, int ku, EREAL alpha,
		       const EREAL *a, int lda, const EREAL *head_x,
		       const EREAL *tail_x, int incx, EREAL beta,
		       EREAL *y, int incy, enum blas_prec_type prec);
...
void BLAS_zgbmv2_z_c_x(enum blas_order_type order, enum blas_trans_type trans,
		       ...
		       const void *tail_x, int incx, const void *beta,
		       void *y, int incy, enum blas_prec_type prec);
void BLAS_zgbmv2_y_c_x(enum blas_order_type order, enum blas_trans_type trans,
		       int m, int n, int kl, int ku, const void *alpha,
		       const void *a, int lda, const void *head_x,
		       const void *tail_x, int incx, const void *beta,
		       void *y, int incy, enum blas_prec_type prec);
