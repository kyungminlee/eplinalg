...
/** $Id: pctrmr.c,v 1.1.1.1 2000/02/15 18:04:09 susan Exp $
  ------------------------------------------------------------------------
    ...
    -- ScaLAPACK routine (version 1.7) --
      ...
      SUBROUTINE PYTRMR2D(UPLO, DIAG, M, N,
     $                     A, IA, JA, ADESC,
     $                     B, IB, JB, BDESC,
     $                     CTXT)
  ------------------------------------------------------------------------
    ...
    PYTRMR2D copies a submatrix of A on a submatrix of B.
...
#define fortran_mr2d pytrmr2do_
#define fortran_mr2dnew pytrmr2d_
#elif defined(UpCase)
#define fortran_mr2dnew PYTRMR2D
#define fortran_mr2d PYTRMR2DO
#define ycopy_ YCOPY
...
#define Ylacpy Cctrlacpy
void  Ylacpy( Int m, Int n, complex *a, Int lda, complex *b, Int ldb );
typedef struct {
  Int   desctype;
  Int   ctxt;
  Int   m;
...
extern void Cygesd2d( Int context, Int m, Int n, complex* A, Int lda, Int rdest, Int cdest );
extern void Cygerv2d( Int context, Int m, Int n, complex* A, Int lda, Int rsrc, Int csrc );
/* lapack */
void  ylacpy_();
/* aux fonctions */
...
extern void Cpytrmr2do( char* uplo, char* diag, Int m, Int n, complex *ptrmyblock, Int ia, Int ja, MDESC *ma, complex *ptrmynewblock, Int ib, Int jb, MDESC *mb );
extern void Cpytrmr2d( char* uplo, char* diag, Int m, Int n, complex *ptrmyblock, Int ia, Int ja, MDESC *ma, complex *ptrmynewblock, Int ib, Int jb, MDESC *mb, Int globcontext );
/* some defines for Cpytrmr2do */
#define SENDBUFF 0
#define RECVBUFF 1
#define SIZEBUFF 2
#if 0
...
{
  Cpytrmr2do(uplo, diag, *m, *n, A, *ia, *ja, (MDESC *) desc_A,
...
{
  Cpytrmr2d(uplo, diag, *m, *n, A, *ia, *ja, (MDESC *) desc_A,
...
void
Cpytrmr2do(char *uplo, char *diag, Int m, Int n,
  ...
  Cpytrmr2d(uplo, diag, m, n, ptrmyblock, ia, ja, ma,
...
void
Cpytrmr2d(char *uplo, char *diag, Int m, Int n,
           complex *ptrmyblock, Int ia, Int ja, MDESC *ma,
           complex *ptrmynewblock, Int ib, Int jb, MDESC *mb,
           Int globcontext){
  ...
  recvptr = ptrrecvbuff;
  {
	...
	if (mesending && recver[step] >= 0 &&
	  ...
	  if (sendsize > 0
	    ...
	    Cygesd2d(gcontext, sendsize, (Int)1, ptrsendbuff, sendsize,
		     (Int)0, proc1[i * q1 + j]);
	  }	/* sendsize > 0 */
	}	/* if (mesending ... */
	if (merecving && sender[step] >= 0 &&
	  ...
	  if (recvsize > 0) {
	    if (step == myrang && mesending) {
	      ...
	      Cygerv2d(gcontext, recvsize, (Int)1, ptrrecvbuff, recvsize,
		       (Int)0, proc0[i * q0 + j]);
	    }
	  }	/* recvsize > 0 */
	}	/* if (merecving ...) */
...
void
Ylacpy(Int m, Int n, complex *a, Int lda, complex *b, Int ldb)
{
  Int   i, j;
  lda -= m;
  ldb -= m;
