 ...
 * 
 * some functions used by the pytrmr2d routine see file pctrmr.c for more
 * documentation.
 * 
...
extern void Cpytrmr2do();
extern void Cpytrmr2d();
...
/* extern functions for intersect() extern ycopy_(); */
/**************************************************************/
...
intersect(char *uplo, char *diag, Int j, Int start,
  ...
  case SENDBUFF:	/* fill buff with local elements to be sent */
    ...
    /* ycopy_(&intervalsize, (char *) (ptrstart), &un, (char *) (*pptrbuff),
     * &un); */
  ...
  case RECVBUFF:	/* fill local memory with the values received */
    ...
    memcpy((char *) ptrstart, (char *) (*pptrbuff),
	   intervalsize * sizeof(complex));
    /* ycopy_(&intervalsize, (char *) (*pptrbuff), &un, (char *) (ptrstart),
     * &un); */
    (*pptrbuff) += intervalsize;
    break;
...
scanD0(char *uplo, char *diag,
       ...
       complex *ptrbuff,	/* address of the communication ptrbuffer (a suffisant
