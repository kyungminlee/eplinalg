...
/** $Id: pdgemr.c,v 1.1.1.1 2000/02/15 18:04:09 susan Exp $
  ...
  ------------------------------------------------------------------------
    ...
    PEGEMR2D copies a submatrix of A on a submatrix of B.
...
#define fortran_mr2d pegemr2do_
#define fortran_mr2dnew pegemr2d_
#elif defined(UpCase)
#define fortran_mr2dnew PEGEMR2D
#define fortran_mr2d PEGEMR2DO
#define ecopy_ ECOPY
...
#define elacpy_ elacpy
#endif
#define Ylacpy Cegelacpy
void  Ylacpy( Int m, Int n, EREAL *a, Int lda, EREAL *b, Int ldb );
typedef struct {
  Int   desctype;
  Int   ctxt;
  Int   m;
...
extern void Cegesd2d( Int context, Int m, Int n, EREAL* A, Int lda, Int rdest, Int cdest );
extern void Cegerv2d( Int context, Int m, Int n, EREAL* A, Int lda, Int rsrc, Int csrc );
/* lapack */
void  elacpy_();
/* aux fonctions */
...
#define scanD0 egescanD0
#define dispmat egedispmat
#define setmemory egesetmemory
#define freememory egefreememory
#define scan_intervals egescan_intervals
extern void scanD0();
extern void dispmat();
extern void setmemory( EREAL** ptr, Int size );
...
extern void Cpegemr2do( Int m, Int n, EREAL *ptrmyblock, Int ia, Int ja, MDESC *ma, EREAL *ptrmynewblock, Int ib, Int jb, MDESC *mb );
extern void Cpegemr2d( Int m, Int n, EREAL *ptrmyblock, Int ia, Int ja, MDESC *ma, EREAL *ptrmynewblock, Int ib, Int jb, MDESC *mb, Int globcontext );
/* some defines for Cpegemr2do */
#define SENDBUFF 0
#define RECVBUFF 1
#define SIZEBUFF 2
#if 0
...
#define DESCLEN 9
void
fortran_mr2d(Int *m, Int *n, EREAL *A, Int *ia, Int *ja, Int desc_A[DESCLEN],
	     EREAL *B, Int *ib, Int *jb, Int desc_B[DESCLEN])
{
  Cpegemr2do(*m, *n, A, *ia, *ja, (MDESC *) desc_A,
	     B, *ib, *jb, (MDESC *) desc_B);
  return;
}
void
fortran_mr2dnew(Int *m, Int *n, EREAL *A, Int *ia, Int *ja, Int desc_A[DESCLEN],
		EREAL *B, Int *ib, Int *jb, Int desc_B[DESCLEN], Int *gcontext)
{
  Cpegemr2d(*m, *n, A, *ia, *ja, (MDESC *) desc_A,
...
static2 Int block2buff( IDESC *vi, Int vinb, IDESC *hi, Int hinb, EREAL *ptra, MDESC *ma, EREAL *buff );
static2 void buff2block( IDESC *vi, Int vinb, IDESC *hi, Int hinb, EREAL *buff, EREAL *ptrb, MDESC *mb );
static2 void gridreshape( Int *ctxtp );
void
Cpegemr2do(Int m, Int n, EREAL *ptrmyblock, Int ia,
           Int ja, MDESC *ma, EREAL *ptrmynewblock, Int ib,
           Int jb, MDESC *mb){
  Int   dummy, nprocs;
  Int   gcontext;
  ...
  Cpegemr2d(m, n, ptrmyblock, ia, ja, ma,
...
void
Cpegemr2d(Int m, Int n, EREAL *ptrmyblock, Int ia,
           Int ja, MDESC *ma, EREAL *ptrmynewblock, Int ib,
           Int jb, MDESC *mb, Int globcontext){
  EREAL *ptrsendbuff, *ptrrecvbuff, *ptrNULL = 0;
  EREAL *recvptr;
  MDESC newa, newb;
  ...
  recvptr = ptrrecvbuff;
  {
	...
	if (mesending && recver[step] >= 0 &&
	  ...
	  if (sendsize > 0
	    ...
	    Cegesd2d(gcontext, sendsize, (Int)1, ptrsendbuff, sendsize,
		     (Int)0, proc1[i * q1 + j]);
	  }	/* sendsize > 0 */
	}	/* if (mesending ... */
	if (merecving && sender[step] >= 0 &&
	  ...
	  if (recvsize > 0) {
	    if (step == myrang && mesending) {
	      ...
	      Cegerv2d(gcontext, recvsize, (Int)1, ptrrecvbuff, recvsize,
		       (Int)0, proc0[i * q0 + j]);
	    }
	  }	/* recvsize > 0 */
	}	/* if (merecving ...) */
...
static2 Int
block2buff(IDESC *vi, Int vinb, IDESC *hi, Int hinb, EREAL *ptra, MDESC *ma, EREAL *buff){
  Int   h, v, sizebuff;
  EREAL *ptr2;
  sizebuff = 0;
  for (h = 0; h < hinb; h++) {
...
buff2block(IDESC *vi, Int vinb, IDESC *hi, Int hinb,
           EREAL *buff, EREAL *ptrb, MDESC *mb){
  Int   h, v, sizebuff;
  EREAL *ptr2;
  sizebuff = 0;
  for (h = 0; h < hinb; h++) {
...
void
Ylacpy(Int m, Int n, EREAL *a, Int lda, EREAL *b, Int ldb)
{
  Int   i, j;
  lda -= m;
  ldb -= m;
