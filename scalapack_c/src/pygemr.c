...
/** $Id: pcgemr.c,v 1.1.1.1 2000/02/15 18:04:09 susan Exp $
  ...
  ------------------------------------------------------------------------
    ...
    PYGEMR2D copies a submatrix of A on a submatrix of B.
...
#define fortran_mr2d pygemr2do_
#define fortran_mr2dnew pygemr2d_
#elif defined(UpCase)
#define fortran_mr2dnew PYGEMR2D
#define fortran_mr2d PYGEMR2DO
#define ycopy_ YCOPY
...
extern void Cpygemr2do( Int m, Int n, complex *ptrmyblock, Int ia, Int ja, MDESC *ma, complex *ptrmynewblock, Int ib, Int jb, MDESC *mb );
extern void Cpygemr2d( Int m, Int n, complex *ptrmyblock, Int ia, Int ja, MDESC *ma, complex *ptrmynewblock, Int ib, Int jb, MDESC *mb, Int globcontext );
/* some defines for Cpygemr2do */
#define SENDBUFF 0
#define RECVBUFF 1
#define SIZEBUFF 2
#if 0
...
{
  Cpygemr2do(*m, *n, A, *ia, *ja, (MDESC *) desc_A,
...
{
  Cpygemr2d(*m, *n, A, *ia, *ja, (MDESC *) desc_A,
...
void
Cpygemr2do(Int m, Int n, complex *ptrmyblock, Int ia,
  ...
  Cpygemr2d(m, n, ptrmyblock, ia, ja, ma,
...
void
Cpygemr2d(Int m, Int n, complex *ptrmyblock, Int ia,
           Int ja, MDESC *ma, complex *ptrmynewblock, Int ib,
  ...
  recvptr = ptrrecvbuff;
  {
	...
	if (mesending && recver[step] >= 0 &&
	  ...
	  if (sendsize > 0
	    ...
	    Cygesd2d(gcontext, sendsize, 1, ptrsendbuff, sendsize,
		     0, proc1[i * q1 + j]);
	  }	/* sendsize > 0 */
	}	/* if (mesending ... */
