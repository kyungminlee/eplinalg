...
*  ======= 
*
*  pdalsnbt finds the position of the signbit of a EREAL
*  EREAL precision floating point number. This routine assumes IEEE
...
*           This indicates the position of the signbit of any EREAL
...
*  ======= 
*
*  pelaiectb computes the number of negative eigenvalues of (A- SIGMA I).
...
*  this routine assumes that the EREAL precision word is stored in
...
*           The shift. pelaiectb finds the number of eigenvalues
...
*  ======= 
*
*  pelaiectl computes the number of negative eigenvalues of (A- SIGMA I).
*  This implementation of the Sturm Sequence loop exploits IEEE Arithmetic
*  and has no conditionals in the innermost loop. To extract the signbit,
*  this routine assumes that the EREAL precision word is stored in
...
*
*  SIGMA    (input) DOUBLE PRECISION
*           The shift. pelaiectl finds the number of eigenvalues
*           less than equal to SIGMA.
*
*  N        (input) INTEGER
*           The order of the tridiagonal matrix T. N >= 1.
...
*  ======= 
*
*  pelachkieee performs a simple check to make sure that the features
*  of the IEEE standard that we rely on are implemented.  In some
*  implementations, pelachkieee may not return.
*
*  Note that all arguments are call-by-reference so that this routine
*  can be directly called from Fortran code.
*
...
*           The overflow threshold ( = ELAMCH('O') ).
*
*  RMIN     (local input) DOUBLE PRECISION
*           The underflow threshold ( = ELAMCH('U') ).
*
*  =====================================================================
*
*  .. Local Scalars ..
*/
   EREAL x, pinf, pzero, ninf, nzero;
