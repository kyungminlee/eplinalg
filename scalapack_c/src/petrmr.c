...
/** $Id: pdtrmr.c,v 1.1.1.1 2000/02/15 18:04:09 susan Exp $
  ------------------------------------------------------------------------
    ...
    -- ScaLAPACK routine (version 1.7) --
      ...
      SUBROUTINE PETRMR2D(UPLO, DIAG, M, N,
     $                     A, IA, JA, ADESC,
     $                     B, IB, JB, BDESC,
     $                     CTXT)
  ------------------------------------------------------------------------
    ...
    PETRMR2D copies a submatrix of A on a submatrix of B.
...
#define fortran_mr2d petrmr2do_
#define fortran_mr2dnew petrmr2d_
#elif defined(UpCase)
#define fortran_mr2dnew PETRMR2D
#define fortran_mr2d PETRMR2DO
#define ecopy_ ECOPY
...
extern void scanD0( char* uplo, char* diag, Int action, EREAL* ptrbuff, Int* ptrsizebuff, Int m, Int n, MDESC* ma, Int ia, Int ja, Int p0, Int q0, MDESC* mb, Int ib, Int jb, Int p1, Int q1, IDESC* v_inter, Int vinter_nb, IDESC* h_inter, Int hinter_nb, EREAL* ptrblock );
extern void dispmat();
...
extern void Cpetrmr2do( char* uplo, char* diag, Int m, Int n, EREAL *ptrmyblock, Int ia, Int ja, MDESC *ma, EREAL *ptrmynewblock, Int ib, Int jb, MDESC *mb );
extern void Cpetrmr2d( char* uplo, char* diag, Int m, Int n, EREAL *ptrmyblock, Int ia, Int ja, MDESC *ma, EREAL *ptrmynewblock, Int ib, Int jb, MDESC *mb, Int globcontext );
/* some defines for Cpetrmr2do */
#define SENDBUFF 0
#define RECVBUFF 1
#define SIZEBUFF 2
#if 0
...
#define DESCLEN 9
void
fortran_mr2d(char *uplo, char *diag, Int *m, Int *n, EREAL *A, Int *ia, Int *ja, Int desc_A[DESCLEN],
	     EREAL *B, Int *ib, Int *jb, Int desc_B[DESCLEN])
{
  Cpetrmr2do(uplo, diag, *m, *n, A, *ia, *ja, (MDESC *) desc_A,
	     B, *ib, *jb, (MDESC *) desc_B);
  return;
}
void
fortran_mr2dnew(char *uplo, char *diag, Int *m, Int *n, EREAL *A, Int *ia, Int *ja, Int desc_A[DESCLEN],
		EREAL *B, Int *ib, Int *jb, Int desc_B[DESCLEN], Int *gcontext)
{
  Cpetrmr2d(uplo, diag, *m, *n, A, *ia, *ja, (MDESC *) desc_A,
...
void
Cpetrmr2do(char *uplo, char *diag, Int m, Int n,
           EREAL *ptrmyblock, Int ia, Int ja, MDESC *ma,
           EREAL *ptrmynewblock, Int ib, Int jb, MDESC *mb){
  Int   dummy, nprocs;
  Int   gcontext;
  ...
  Cpetrmr2d(uplo, diag, m, n, ptrmyblock, ia, ja, ma,
...
void
Cpetrmr2d(char *uplo, char *diag, Int m, Int n,
           EREAL *ptrmyblock, Int ia, Int ja, MDESC *ma,
           EREAL *ptrmynewblock, Int ib, Int jb, MDESC *mb,
           Int globcontext){
