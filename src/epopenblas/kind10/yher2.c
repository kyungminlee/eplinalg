/*
 * yher2 — kind10 port of OpenBLAS zher2.  Hermitian rank-2 update.
 *
 ...
 *
 * Fortran ABI:  subroutine yher2(uplo, n, alpha, x, incx, y, incy, a, lda)
 */
...
void yher2_(const char *UPLO, const int *N, const C *ALPHA,
