 ...
 *
 * Kernel-isolated C perf harness for esbmv (overlay vs migrated).
...
BLAS_EXTERN void esbmv_(const char *, const int *, const int *,
    const R10 *, const R10 *, const int *, const R10 *, const int *,
    const R10 *, R10 *, const int *, size_t);
BLAS_EXTERN void esbmv_migrated_(const char *, const int *, const int *,
    const R10 *, const R10 *, const int *, const R10 *, const int *,
    const R10 *, R10 *, const int *, size_t);
