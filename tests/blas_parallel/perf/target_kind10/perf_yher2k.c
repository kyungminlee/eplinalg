 ...
 *
 * Kernel-isolated C perf harness for yher2k (overlay vs migrated).
...
BLAS_EXTERN void yher2k_(const char *, const char *, const int *, const int *,
    const C10 *, const C10 *, const int *,
    const C10 *, const int *,
    const R10 *, C10 *, const int *, size_t, size_t);
BLAS_EXTERN void yher2k_migrated_(const char *, const char *, const int *, const int *,
    const C10 *, const C10 *, const int *,
    const C10 *, const int *,
    const R10 *, C10 *, const int *, size_t, size_t);
...
static void run_one(char uplo, char trans, int N, int K, int iters, int warmup) {
    ...
    perf_emit("yher2k", key, N, iters, flops, t_ov, t_mg);
    perf_emit_json("yher2k", key, N, iters, flops, t_ov, t_mg);
