 ...
 *
 * Kernel-isolated C perf harness for etrmm (overlay vs migrated).
...
BLAS_EXTERN void etrmm_(const char *, const char *, const char *, const char *,
    const int *, const int *, const R10 *,
    const R10 *, const int *, R10 *, const int *,
    size_t, size_t, size_t, size_t);
BLAS_EXTERN void etrmm_migrated_(const char *, const char *, const char *, const char *,
    const int *, const int *, const R10 *,
    const R10 *, const int *, R10 *, const int *,
    size_t, size_t, size_t, size_t);
...
static void run_one(char side, char uplo, char trans, char diag,
    ...
    perf_emit("etrmm", key, N, iters, flops, t_subject, t_mg);
    perf_emit_json("etrmm", key, N, iters, flops, t_subject, t_mg);
