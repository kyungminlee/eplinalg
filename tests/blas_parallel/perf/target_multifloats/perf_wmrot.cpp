 ...
 *
 * Kernel-isolated C perf harness for wmrot (overlay vs migrated).
...
BLAS_EXTERN void wmrot_(const int *, MFC *, const int *, MFC *, const int *,
    const MFR *, const MFR *);
BLAS_EXTERN void wmrot_migrated_(const int *, MFC *, const int *, MFC *, const int *,
    const MFR *, const MFR *);
