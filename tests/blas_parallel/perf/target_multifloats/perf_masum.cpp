 ...
 *
 * Kernel-isolated C perf harness for masum (overlay vs migrated).
...
BLAS_EXTERN MFR masum_(const int *, const MFR *, const int *);
BLAS_EXTERN MFR masum_migrated_(const int *, const MFR *, const int *);
