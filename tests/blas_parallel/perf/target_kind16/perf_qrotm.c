 ...
 *
 * Kernel-isolated C perf harness for qrotm (overlay vs migrated).
...
BLAS_EXTERN void qrotm_(const int *, Q16 *, const int *, Q16 *, const int *,
    const Q16 *);
BLAS_EXTERN void qrotm_migrated_(const int *, Q16 *, const int *, Q16 *, const int *,
    const Q16 *);

static void run_one(int N, int iters, int warmup) {
    int one = 1;
    Q16 PARAM[5] = { Q16_FROM(0.7), Q16_FROM(0.7), Q16_FROM(0.7), Q16_FROM(0.7), Q16_FROM(0.7) };
    ...
    perf_emit("qrotm", "-", N, iters, flops, t_subject, t_mg);
    perf_emit_json("qrotm", "-", N, iters, flops, t_subject, t_mg);
