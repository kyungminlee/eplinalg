...
static void run_one(int N, int iters, int warmup) {
    ...
    perf_emit("qrot", "-", N, iters, flops, t_subject, t_mg);
    perf_emit_json("qrot", "-", N, iters, flops, t_subject, t_mg);
