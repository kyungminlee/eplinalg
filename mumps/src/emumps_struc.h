...
!    ----------------------------------------
        ...
        REAL(KIND=10), DIMENSION(:), POINTER :: A
...
!    --------------
        ...
        REAL(KIND=10), DIMENSION(:), POINTER :: PIVOTS
!
!       ------------------------------------
...
!       ------------------------------------
        ...
        REAL(KIND=10), DIMENSION(:), POINTER :: A_loc, pad2
!
!    ----------------------------------------
...
!    ----------------------------------------
        ...
        REAL(KIND=10), DIMENSION(:), POINTER :: A_ELT, pad4
!
!    ---------------------------------------------
...
!    -------------------------------------------------------
        REAL(KIND=10), DIMENSION(:), POINTER :: RHS, REDRHS
        REAL(KIND=10), DIMENSION(:), POINTER :: RHS_SPARSE
        REAL(KIND=10), DIMENSION(:), POINTER :: SOL_loc
        REAL(KIND=10), DIMENSION(:), POINTER :: RHS_loc
...
!    -----
        ...
        INTEGER ::  SIZE_SCHUR
        REAL(KIND=10), DIMENSION(:), POINTER :: SCHUR
        REAL(KIND=10), DIMENSION(:), POINTER :: SCHUR_CINTERFACE
        INTEGER, DIMENSION(:), POINTER :: LISTVAR_SCHUR
!    -------------------------------------
!    Case of distributed matrix on entry:
!    EMUMPS potentially provides mapping
!    -------------------------------------
...
!       main real working arrays for factorization/solve phases
        REAL(KIND=10), DIMENSION(:), POINTER :: S
...
!       Compressed RHS
        ...
        REAL(KIND=10), DIMENSION(:),   POINTER :: RHSINTR
!       Info on the subtrees to be used during factorization
        ...
        REAL(KIND=10), DIMENSION(:),   POINTER :: WK_USER
        INTEGER :: NBSA_LOCAL
        INTEGER :: LWK_USER
