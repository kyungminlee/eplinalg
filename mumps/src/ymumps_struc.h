...
!    ----------------------------------------
        ...
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: A
        INTEGER, DIMENSION(:), POINTER :: IRN, JCN
!    --------------
!    Scaling arrays
!    --------------
        REAL(KIND=10), DIMENSION(:), POINTER :: COLSCA, ROWSCA
        REAL(KIND=10), DIMENSION(:), POINTER :: COLSCA_loc
        REAL(KIND=10), DIMENSION(:), POINTER :: ROWSCA_loc
        INTEGER, DIMENSION(:), POINTER :: ROWIND, COLIND
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: PIVOTS
!
!       ------------------------------------
...
!       ------------------------------------
        ...
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: A_loc, pad2
!
!    ----------------------------------------
...
!    ----------------------------------------
        ...
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: A_ELT, pad4
!
!    ---------------------------------------------
...
!    -------------------------------------------------------
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: RHS, REDRHS
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: RHS_SPARSE
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: SOL_loc
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: RHS_loc
...
!    ---------------------------
        ...
        INTEGER ::  INFO(80) 
        INTEGER :: INFOG(80)
        REAL(KIND=10) ::  COST_SUBTREES
        REAL(KIND=10) ::  CNTL(15)
        REAL(KIND=10) ::  RINFO(40)
        REAL(KIND=10) ::  RINFOG(40)
...
!    -----
        ...
        INTEGER ::  SIZE_SCHUR
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: SCHUR
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: SCHUR_CINTERFACE
        INTEGER, DIMENSION(:), POINTER :: LISTVAR_SCHUR
!    -------------------------------------
!    Case of distributed matrix on entry:
!    YMUMPS potentially provides mapping
!    -------------------------------------
...
!       main real working arrays for factorization/solve phases
        COMPLEX(KIND=10), DIMENSION(:), POINTER :: S
...
!       Compressed RHS
        ...
        COMPLEX(KIND=10), DIMENSION(:),   POINTER :: RHSINTR
!       Info on the subtrees to be used during factorization
        ...
        COMPLEX(KIND=10), DIMENSION(:),   POINTER :: WK_USER
        INTEGER :: NBSA_LOCAL
        INTEGER :: LWK_USER
!    Internal control array
        REAL(KIND=10) ::  DKEEP(230)
...
! for RR on root
        REAL(KIND=10), DIMENSION(:), POINTER :: SINGULAR_VALUES
