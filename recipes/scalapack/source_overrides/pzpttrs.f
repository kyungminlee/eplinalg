...
*
      IF( INFO.LT.0 ) THEN
         CALL PXERBLA( ICTXT, 'PZPTTRS', -INFO )
         RETURN
      END IF
*
...
*
         CALL PZPTTRSV( 'L', 'N', N, NRHS, D( PART_OFFSET+1 ),
     $                  E( PART_OFFSET+1 ), JA_NEW, DESCA_1XP, B, IB,
     $                  DESCB_PX1, AF, LAF, WORK, LWORK, INFO )
*
      ELSE
*
         CALL PZPTTRSV( 'U', 'C', N, NRHS, D( PART_OFFSET+1 ),
     $                  E( PART_OFFSET+1 ), JA_NEW, DESCA_1XP, B, IB,
     $                  DESCB_PX1, AF, LAF, WORK, LWORK, INFO )
*
      ENDIF
...
*
        DO 10  I=PART_OFFSET+1, PART_OFFSET+ODD_SIZE
          CALL ZSCAL( NRHS, DCMPLX( CONE/D( I ) ), B( I ), LLDB )
   10   CONTINUE
*
...
*
      IF( MYCOL .LT. NPCOL-1 ) THEN
        I=PART_OFFSET+ODD_SIZE+1
          CALL ZSCAL( NRHS, CONE/AF( ODD_SIZE+2 ), B( I ), LLDB )
      ENDIF
*
...
*
      IF( LSAME( UPLO, 'L' ) ) THEN
*
         CALL PZPTTRSV( 'L', 'C', N, NRHS, D( PART_OFFSET+1 ),
     $                  E( PART_OFFSET+1 ), JA_NEW, DESCA_1XP, B, IB,
     $                  DESCB_PX1, AF, LAF, WORK, LWORK, INFO )
*
      ELSE
*
         CALL PZPTTRSV( 'U', 'N', N, NRHS, D( PART_OFFSET+1 ),
     $                  E( PART_OFFSET+1 ), JA_NEW, DESCA_1XP, B, IB,
     $                  DESCB_PX1, AF, LAF, WORK, LWORK, INFO )
*
      ENDIF
