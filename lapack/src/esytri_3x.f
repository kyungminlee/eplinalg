...
*
*> \htmlonly
*> Download ESYTRI_3X + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/esytri_3x.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/esytri_3x.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/esytri_3x.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE ESYTRI_3X( UPLO, N, A, LDA, E, IPIV, WORK, NB, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*       .. Array Arguments ..
*       INTEGER            IPIV( * )
*       REAL(KIND=10)   A( LDA, * ),  E( * ), WORK( N+NB+1, * )
*       ..
*
*
*> \par Purpose:
...
*>
*> \verbatim
*> ESYTRI_3X computes the inverse of a real symmetric indefinite
*> matrix A using the factorization computed by ESYTRF_RK or DSYTRF_BK:
*>
...
*>          factors U or L as computed by ESYTRF_RK and DSYTRF_BK:
...
*>          as determined by ESYTRF_RK or DSYTRF_BK.
*> \endverbatim
*>
*> \param[out] WORK
*> \verbatim
...
*
*  =====================================================================
      SUBROUTINE ESYTRI_3X( UPLO, N, A, LDA, E, IPIV, WORK, NB,         
     +              INFO )
*
...
*     .. Local Scalars ..
      ...
      REAL(KIND=10)   AK, AKKP1, AKP1, D, T, U01_I_J, U01_IP1_J,        
     +            U11_I_J, U11_IP1_J
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*     .. External Subroutines ..
      EXTERNAL           EGEMM, ESYSWAPR, ETRTRI, ETRMM,                
     +    XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
            CALL EGEMM( 'T', 'N', NNB, NNB, CUT, ONE, A( 1, CUT+1 ),    
...
*           L11**T * invD1 * L11 -> L11
*
            CALL ETRMM( 'L', UPLO, 'T', 'U', NNB, NNB, ONE,             
...
*
               CALL EGEMM( 'T', 'N', NNB, NNB, N-NNB-CUT, ONE,          
