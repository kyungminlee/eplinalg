*> \brief \b ELASD4 computes the square root of the i-th updated eigenvalue of a positive symmetric rank-one modification to a positive diagonal matrix. Used by ebdsdc.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download ELASD4 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/elasd4.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/elasd4.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/elasd4.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE ELASD4( N, I, D, Z, DELTA, RHO, SIGMA, WORK, INFO )
*
*       .. Scalar Arguments ..
*       INTEGER            I, INFO, N
*       REAL(KIND=10)   RHO, SIGMA
*       ..
*       .. Array Arguments ..
*       REAL(KIND=10)   D( * ), DELTA( * ), WORK( * ), Z( * )
*       ..
*
*
*> \par Purpose:
...
*> \param[out] DELTA
*> \verbatim
*>          DELTA is REAL(KIND=10) array, dimension ( N )
...
*     .. Parameters ..
      INTEGER            MAXIT
      PARAMETER          ( MAXIT = 400 )
      REAL(KIND=10)   ZERO, ONE, TWO, THREE, FOUR, EIGHT, TEN
      PARAMETER          ( ZERO = 0.0E0_10, ONE = 1.0E0_10, TWO = 
     +2.0E0_10,                    THREE = 3.0E0_10, FOUR = 4.0E0_10, 
     +EIGHT = 8.0E0_10,                    TEN = 10.0E0_10 )
*     ..
*     .. Local Scalars ..
      LOGICAL            ORGATI, SWTCH, SWTCH3, GEOMAVG
      INTEGER            II, IIM1, IIP1, IP1, ITER, J, NITER
      REAL(KIND=10)   A, B, C, DELSQ, DELSQ2, SQ2, DPHI, DPSI, DTIIM,   
     +                 DTIIP, DTIPSQ, DTISQ, DTNSQ, DTNSQ1, DW, EPS,    
     +                ERRETM, ETA, PHI, PREW, PSI, RHOINV, SGLB,        
     +            SGUB, TAU, TAU2, TEMP, TEMP1, TEMP2, W
*     ..
*     .. Local Arrays ..
      REAL(KIND=10)   DD( 3 ), ZZ( 3 )
*     ..
*     .. External Subroutines ..
      EXTERNAL           ELAED6, ELASD5
*     ..
*     .. External Functions ..
      REAL(KIND=10)   ELAMCH
      EXTERNAL           ELAMCH
...
*
      ...
      END IF
      IF( N.EQ.2 ) THEN
         CALL ELASD5( I, D, Z, DELTA, RHO, SIGMA, WORK )
         RETURN
      END IF
*
...
*
     ...
     $             ( D( IIP1 )-D( IIM1 ) )*( D( IIM1 )+D( IIP1 ) )*TEMP1
            ...
            DD( 3 ) = DTIIP
            CALL ELAED6( NITER, ORGATI, C, DD, ZZ, W, ETA, INFO )
*
            IF( INFO.NE.0 ) THEN
*
*              If INFO is not 0, i.e., ELAED6 failed, switch back
...
*
               IF( INFO.NE.0 ) THEN
*
*                 If INFO is not 0, i.e., ELAED6 failed, switch
