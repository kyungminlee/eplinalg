*> \brief \b ELAQR5 performs a single small-bulge multi-shift QR sweep.
*
*  =========== DOCUMENTATION ===========
*
...
*
*> \htmlonly
*> Download ELAQR5 + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/elaqr5.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/elaqr5.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/elaqr5.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE ELAQR5( WANTT, WANTZ, KACC22, N, KTOP, KBOT, NSHFTS,
...
*> \verbatim
*>
*>    ELAQR5, called by ELAQR0, performs a
...
*>             orthogonal updates.
*>        = 0: ELAQR5 does not accumulate reflections and does not
*>             use matrix-matrix multiply to update far-from-diagonal
*>             matrix entries.
*>        = 1: ELAQR5 accumulates reflections and uses matrix-matrix
...
*> \param[in,out] SR
*> \verbatim
*>          SR is REAL(KIND=10) array, dimension (NSHFTS)
*> \endverbatim
*>
*> \param[in,out] SI
*> \verbatim
*>          SI is REAL(KIND=10) array, dimension (NSHFTS)
...
*> \param[in,out] Z
*> \verbatim
*>          Z is REAL(KIND=10) array, dimension (LDZ,IHIZ)
...
*> \param[out] V
*> \verbatim
*>          V is REAL(KIND=10) array, dimension (LDV,NSHFTS/2)
*> \endverbatim
*>
*> \param[in] LDV
*> \verbatim
...
*> \param[out] U
*> \verbatim
*>          U is REAL(KIND=10) array, dimension (LDU,2*NSHFTS)
*> \endverbatim
*>
*> \param[in] LDU
*> \verbatim
...
*> \param[out] WV
*> \verbatim
*>          WV is REAL(KIND=10) array, dimension (LDWV,2*NSHFTS)
*> \endverbatim
*>
*> \param[in] LDWV
*> \verbatim
...
*> \param[out] WH
*> \verbatim
*>          WH is REAL(KIND=10) array, dimension (LDWH,NH)
*> \endverbatim
*>
*> \param[in] LDWH
*> \verbatim
...
*     .. External Subroutines ..
      EXTERNAL           EGEMM, ELACPY, ELAQR1, ELARFG, ELASET,         
     +           ETRMM
*     ..
...
*
     ...
     +                    LDWH )
               CALL ELACPY( 'ALL', NU, JLEN, WH, LDWH,                  
     +        H( INCOL+K1, JCOL ), LDH )
  150       CONTINUE
*
*           ==== Vertical multiply ====
*
     ...
     +LDU, ZERO, WV, LDWV )
               CALL ELACPY( 'ALL', JLEN, NU, WV, LDWV,                  
     +     H( JROW, INCOL+K1 ), LDH )
  160       CONTINUE
*
