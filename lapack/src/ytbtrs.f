...
*
*> \htmlonly
*> Download YTBTRS + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ytbtrs.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ytbtrs.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ytbtrs.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE YTBTRS( UPLO, TRANS, DIAG, N, KD, NRHS, AB, LDAB, B,
*                          LDB, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> YTBTRS solves a triangular system of the form
*>
...
*
      DO 30 J = 1, NRHS
         CALL YTBSV( UPLO, TRANS, DIAG, N, KD, AB, LDAB, B( 1, J ),     
     +           1 )
   30 CONTINUE
*
      RETURN
