...
*
*> \htmlonly
*> Download YTRTRS + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ytrtrs.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ytrtrs.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ytrtrs.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
...
*> \verbatim
*>
*> YTRTRS solves a triangular system of the form
*>
...
*
      CALL YTRSM( 'Left', UPLO, TRANS, DIAG, N, NRHS, ONE, A, LDA, B,   
     +          LDB )
*
      RETURN
*
