...
*
*> \htmlonly
*> Download YLARFB_GETT + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ylarfb_gett.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ylarfb_gett.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ylarfb_gett.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE YLARFB_GETT( IDENT, M, N, K, T, LDT, A, LDA, B, LDB,
*      $                        WORK, LDWORK )
*       IMPLICIT NONE
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> YLARFB_GETT applies a complex Householder block reflector H from the
...
*
         DO J = 1, N-K
            CALL YCOPY( K, A( 1, K+J ), 1, WORK( 1, J ), 1 )
         END DO
...
*
*
            CALL YTRMM( 'L', 'L', 'C', 'U', K, N-K, CONE, A, LDA,       
     +            WORK, LDWORK )
         END IF
*
...
*
         IF( M.GT.0 ) THEN
            CALL YGEMM( 'C', 'N', K, N-K, M, CONE, B, LDB,              
...
*
         CALL YTRMM( 'L', 'U', 'N', 'N', K, N-K, CONE, T, LDT,          
     +      WORK, LDWORK )
*
...
*
         IF( M.GT.0 ) THEN
            CALL YGEMM( 'N', 'N', M, N-K, K, -CONE, B, LDB,             
...
*           V1 stored in A1 (diagonal ones are not stored).
*
            CALL YTRMM( 'L', 'L', 'N', 'U', K, N-K, CONE, A, LDA,       
     +            WORK, LDWORK )
         END IF
*
...
*
      DO J = 1, K
         CALL YCOPY( J, A( 1, J ), 1, WORK( 1, J ), 1 )
      END DO
*
...
*
         CALL YTRMM( 'L', 'L', 'C', 'U', K, K, CONE, A, LDA,            
     +    WORK, LDWORK )
      END IF
*
...
*     W1 is upper-triangular with zeroes below the diagonal.
*
      CALL YTRMM( 'L', 'U', 'N', 'N', K, K, CONE, T, LDT,             
     +WORK, LDWORK )
*
...
*
      IF( M.GT.0 ) THEN
         CALL YTRMM( 'R', 'U', 'N', 'N', M, K, -CONE, WORK, LDWORK,     
     +           B, LDB )
      END IF
*
      IF( LNOTIDENT ) THEN
...
*
         CALL YTRMM( 'L', 'L', 'N', 'U', K, K, CONE, A, LDA,            
     +    WORK, LDWORK )
*
