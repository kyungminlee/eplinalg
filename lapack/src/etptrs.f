...
*
*> \htmlonly
*> Download ETPTRS + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/etptrs.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/etptrs.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/etptrs.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE ETPTRS( UPLO, TRANS, DIAG, N, NRHS, AP, B, LDB, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> ETPTRS solves a triangular system of the form
*>
*>    A * X = B  or  A**T * X = B,
*>
...
*
*  =====================================================================
      SUBROUTINE ETPTRS( UPLO, TRANS, DIAG, N, NRHS, AP, B, LDB,        
     +            INFO )
*
...
*
      DO 30 J = 1, NRHS
         CALL ETPSV( UPLO, TRANS, DIAG, N, AP, B( 1, J ), 1 )
   30 CONTINUE
*
      RETURN
*
