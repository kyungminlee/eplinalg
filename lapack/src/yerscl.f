*> \brief \b YERSCL multiplies a vector by the reciprocal of a real scalar.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE YERSCL( N, SA, SX, INCX )
*
*       .. Scalar Arguments ..
*       INTEGER            INCX, N
*       REAL(KIND=10)   SA
...
*> \verbatim
*>
*> YERSCL multiplies an n-element complex vector x by the real scalar
...
*> \param[in,out] SX
*> \verbatim
*>          SX is COMPLEX(KIND=10) array, dimension
*>                         (1+(N-1)*abs(INCX))
