...
*
*> \htmlonly
*> Download ETBTRS + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/etbtrs.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/etbtrs.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/etbtrs.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE ETBTRS( UPLO, TRANS, DIAG, N, KD, NRHS, AB, LDAB, B,
*                          LDB, INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> ETBTRS solves a triangular system of the form
*>
*>    A * X = B  or  A**T * X = B,
*>
...
*
      DO 30 J = 1, NRHS
         CALL ETBSV( UPLO, TRANS, DIAG, N, KD, AB, LDAB, B( 1, J ),     
     +           1 )
   30 CONTINUE
*
      RETURN
