...
*
*> \htmlonly
*> Download ELARFB_GETT + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/elarfb_gett.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/elarfb_gett.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/elarfb_gett.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE ELARFB_GETT( IDENT, M, N, K, T, LDT, A, LDA, B, LDB,
*      $                        WORK, LDWORK )
*       IMPLICIT NONE
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> ELARFB_GETT applies a real Householder block reflector H from the
...
*
         DO J = 1, N-K
            CALL ECOPY( K, A( 1, K+J ), 1, WORK( 1, J ), 1 )
         END DO
...
*
*
            CALL ETRMM( 'L', 'L', 'T', 'U', K, N-K, ONE, A, LDA,        
     +           WORK, LDWORK )
         END IF
*
...
*
         IF( M.GT.0 ) THEN
            CALL EGEMM( 'T', 'N', K, N-K, M, ONE, B, LDB,               
...
*
         CALL ETRMM( 'L', 'U', 'N', 'N', K, N-K, ONE, T, LDT,           
     +     WORK, LDWORK )
*
...
*
         IF( M.GT.0 ) THEN
            CALL EGEMM( 'N', 'N', M, N-K, K, -ONE, B, LDB,              
...
*           V1 stored in A1 (diagonal ones are not stored).
*
            CALL ETRMM( 'L', 'L', 'N', 'U', K, N-K, ONE, A, LDA,        
     +           WORK, LDWORK )
         END IF
*
...
*
      DO J = 1, K
         CALL ECOPY( J, A( 1, J ), 1, WORK( 1, J ), 1 )
      END DO
*
...
*
         CALL ETRMM( 'L', 'L', 'T', 'U', K, K, ONE, A, LDA,             
     +   WORK, LDWORK )
      END IF
*
...
*     W1 is upper-triangular with zeroes below the diagonal.
*
      CALL ETRMM( 'L', 'U', 'N', 'N', K, K, ONE, T, LDT,             
     +WORK, LDWORK )
*
...
*
      IF( M.GT.0 ) THEN
         CALL ETRMM( 'R', 'U', 'N', 'N', M, K, -ONE, WORK, LDWORK,      
     +          B, LDB )
      END IF
*
      IF( LNOTIDENT ) THEN
...
*
         CALL ETRMM( 'L', 'L', 'N', 'U', K, K, ONE, A, LDA,             
     +   WORK, LDWORK )
*
