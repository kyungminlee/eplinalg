...
*
*> \htmlonly
*> Download YSYTRI_3X + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/ysytri_3x.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/ysytri_3x.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/ysytri_3x.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE YSYTRI_3X( UPLO, N, A, LDA, E, IPIV, WORK, NB, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
...
*>
*> \verbatim
*> YSYTRI_3X computes the inverse of a complex symmetric indefinite
*> matrix A using the factorization computed by YSYTRF_RK or ZSYTRF_BK:
*>
...
*>          factors U or L as computed by YSYTRF_RK and ZSYTRF_BK:
...
*>          as determined by YSYTRF_RK or ZSYTRF_BK.
*> \endverbatim
*>
*> \param[out] WORK
*> \verbatim
...
*
*  =====================================================================
      SUBROUTINE YSYTRI_3X( UPLO, N, A, LDA, E, IPIV, WORK, NB,         
     +              INFO )
*
...
*     .. Local Scalars ..
      ...
      COMPLEX(KIND=10)         AK, AKKP1, AKP1, D, T, U01_I_J, 
     +U01_IP1_J,                    U11_I_J, U11_IP1_J
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      EXTERNAL           LSAME
...
*     .. External Subroutines ..
      EXTERNAL           YGEMM, YSYSWAPR, YTRTRI, YTRMM,                
     +    XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
            CALL YGEMM( 'T', 'N', NNB, NNB, CUT, CONE, A( 1, CUT+1 ),   
...
*
         DO I = 1, N
             IP = ABS( IPIV( I ) )
             IF( IP.NE.I ) THEN
                IF (I .LT. IP) CALL YSYSWAPR( UPLO, N, A, LDA, I ,      
     +          IP )
                IF (I .GT. IP) CALL YSYSWAPR( UPLO, N, A, LDA, IP ,     
     +           I )
             END IF
         END DO
*
...
*           L11**T * invD1 * L11 -> L11
*
            CALL YTRMM( 'L', UPLO, 'T', 'U', NNB, NNB, CONE,            
...
*
               CALL YGEMM( 'T', 'N', NNB, NNB, N-NNB-CUT, CONE,         
...
*              L01 =  L22**T * invD2 * L21
*
               CALL YTRMM( 'L', UPLO, 'T', 'U', N-NNB-CUT, NNB, CONE,   
