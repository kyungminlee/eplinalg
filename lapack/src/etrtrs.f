...
*
*> \htmlonly
*> Download ETRTRS + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/etrtrs.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/etrtrs.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/etrtrs.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE ETRTRS( UPLO, TRANS, DIAG, N, NRHS, A, LDA, B, LDB,
*                          INFO )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> ETRTRS solves a triangular system of the form
*>
*>    A * X = B  or  A**T * X = B,
*>
...
*
      CALL ETRSM( 'Left', UPLO, TRANS, DIAG, N, NRHS, ONE, A, LDA, B,   
     +          LDB )
*
      RETURN
*
