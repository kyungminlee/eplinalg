!> \brief \b ELASSQ updates a sum of squares represented in scaled form.
!
!  =========== DOCUMENTATION ===========
!
...
!
!> \htmlonly
!> Download ELASSQ + dependencies
!> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/elassq.f90">
!> [TGZ]</a>
!> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/elassq.f90">
!> [ZIP]</a>
!> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/elassq.f90">
!> [TXT]</a>
!> \endhtmlonly
!
!  Definition:
!  ===========
!
!       SUBROUTINE ELASSQ( N, X, INCX, SCALE, SUMSQ )
!
!       .. Scalar Arguments ..
!       INTEGER            INCX, N
...
!> \verbatim
!>
!> ELASSQ returns the values scale_out and sumsq_out such that
!>
...
!> \param[in] X
!> \verbatim
!>          X is REAL(KIND=10) array, dimension (1+(N-1)*abs(INCX))
