*> \brief \b ELARF1F applies an elementary reflector to a general rectangular
...
*
*> \htmlonly
*> Download ELARF1F + dependencies
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/elarf1f.f">
*> [TGZ]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/elarf1f.f">
*> [ZIP]</a>
*> <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/elarf1f.f">
*> [TXT]</a>
*> \endhtmlonly
*
*  Definition:
*  ===========
*
*       SUBROUTINE ELARF1F( SIDE, M, N, V, INCV, TAU, C, LDC, WORK )
*
*       .. Scalar Arguments ..
*       CHARACTER          SIDE
...
*> \verbatim
*>
*> ELARF1F applies a real elementary reflector H to a real m by n matrix
...
*                    = C_1**T + C_2**T v ( EGEMM then EAXPY )
*        C  = C - \tau vv**T C
*           = C - \tau vw**T
*        Giving us   C_1 = C_1 - \tau w**T ( EAXPY )
*                 and
*                    C_2 = C_2 - \tau v_2w**T ( EGER )
*     If SIDE='R'
*
*        C = [ C_1 C_2 ]
...
*                 = C_1 + C_2v_2 ( EGEMM then EAXPY )
*        C  = C - \tau Cvv**T
*           = C - \tau wv**T
*        Giving us   C_1 = C_1 - \tau w ( EAXPY )
*                 and
*                    C_2 = C_2 - \tau wv_2**T ( EGER )
*
*  Authors:
*  ========
*
...
*     .. External Subroutines ..
      EXTERNAL           EGEMV, EGER, EAXPY, ESCAL
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
