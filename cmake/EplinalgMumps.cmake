...
if(NOT BASELINE_BUILD)
    ...
    if(TARGET ${LIB_PREFIX}mumps)
        ...
        _add_mumps_ordering_defines(${LIB_PREFIX}mumps)
    ...
    #
    # Built here (not test-only) so ``find_package(qmumps)`` delivers a
    ...
    if(TARGET ${LIB_PREFIX}mumps
        ...
        # ${LIB_PREFIX}mumps_full RESCAN below resolves.
