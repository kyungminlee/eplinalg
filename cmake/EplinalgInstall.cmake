...
# baked at target creation (``libpord_mumps.a`` …) — they must NOT go
# through fortran_install_library (which would re-tag the filename), so
# the export + a minimal Config are emitted by hand. mumps_common and
# the genuine/typed solvers reach these via
...
function(_install_ordering_package)
    ...
    set(_cfg "\
# eplinalgOrderingConfig.cmake — auto-generated by cmake/EplinalgInstall.cmake
# Sequential MUMPS ordering leaf archives (PORD / METIS / Scotch /
# esmumps). Pure-C archives with a stable, flavor-independent ABI, so no
# tag matching is needed — a single untagged targets file suffices.
# The MPI-ABI-bound PT-Scotch is packaged separately (eplinalgPtscotch).
