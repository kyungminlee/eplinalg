/*
 * Self-contained MUMPS C header for the migrated ymumps archive
 * (x87 80-bit ``long double``; complex arithmetic; prefix
 * y/Y, maps to upstream ``z``).
 *
 * Declares YMUMPS_STRUC_C and ymumps_c() directly instead of
 ...
 * widths use this target's YMUMPS_REAL / YMUMPS_COMPLEX (mumps_long_double (scalar) / mumps_long_double_complex (complex)),
 * defined below. This makes the struct ABI-identical to the ymumps
 * bridge object (upstream ``mumps_c.c`` compiled with
 * -DZMUMPS_STRUC_C=YMUMPS_STRUC_C -Dzmumps_c=ymumps_c and force-including
...
#endif
#define YMUMPS_REAL    mumps_long_double
#define YMUMPS_COMPLEX mumps_long_double_complex
 ...
 * NB: YMUMPS_COMPLEX are REAL types in s and d arithmetics.
 */
typedef struct {
    ...
    MUMPS_INT      *irn_loc;
    MUMPS_INT      *jcn_loc;
    YMUMPS_COMPLEX *a_loc;

    /* Element entry */
    MUMPS_INT      nelt;
    MUMPS_INT      *eltptr;
    MUMPS_INT      *eltvar;
    YMUMPS_COMPLEX *a_elt;
    ...
    YMUMPS_REAL    *colsca_loc;
    YMUMPS_REAL    *rowsca_loc;

    /* Info after facto */
    MUMPS_INT      *rowind;
    MUMPS_INT      *colind;
    YMUMPS_COMPLEX *pivots;

    /* RHS, solution, ouptput data and statistics */
    YMUMPS_COMPLEX *rhs, *redrhs, *rhs_sparse, *sol_loc, *rhs_loc, *rhsintr;
    ...
    YMUMPS_REAL    rinfo[40], rinfog[40];

    /* Null space */
    MUMPS_INT      deficiency;
    MUMPS_INT      *pivnul_list;
    MUMPS_INT      *mapping;
    YMUMPS_REAL    *singular_values;

    /* Schur */
    MUMPS_INT      size_schur;
    MUMPS_INT      *listvar_schur;
    YMUMPS_COMPLEX *schur;

    /* user workspace */
    YMUMPS_COMPLEX *wk_user;
...
void MUMPS_CALL
ymumps_c( YMUMPS_STRUC_C * ymumps_par );
