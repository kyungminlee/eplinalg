...
#ifdef __STDC__
void penrm2_( Int * N, EREAL * NORM2,
              EREAL * X, Int * IX, Int * JX, Int * DESCX, Int * INCX )
#else
void penrm2_( N, NORM2, X, IX, JX, DESCX, INCX )
/*
*  .. Scalar Arguments ..
*/
   Int            * INCX, * IX, * JX, * N;
...
*  =======
*
*  PENRM2  computes the 2-norm of a subvector sub( X ),
*
*  where
*
...
*/
   ...
   EREAL         scale, ssq, temp1, temp2;
/*
*  .. Local Arrays ..
*/
   Int            Xd[DLEN_];
   EREAL         * Xptr = NULL, work[4];
/* ..
...
*/
   ...
   if( !( info = ( ( nprow == -1 ) ? -( 601 + CTXT_ ) : 0 ) ) )
      PB_Cchkvec( ctxt, "PENRM2", "X", *N, 1, Xi, Xj, Xd, *INCX, 6, &info );
   if( info ) { PB_Cabort( ctxt, "PENRM2", info ); return; }
#endif
/*
*  Initialize NORM2
*/
