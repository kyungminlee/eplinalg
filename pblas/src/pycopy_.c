...
#else
void pycopy_( N, X, IX, JX, DESCX, INCX, Y, IY, JY, DESCY, INCY )
/*
*  .. Scalar Arguments ..
*/
...
*  =======
*
*  PYCOPY  copies one subvector into another,
*
*     sub( Y ) := sub( X ),
*
*  where
...
*/
   ...
   {
      PB_Cchkvec( ctxt, "PYCOPY", "X", *N, 1, Xi, Xj, Xd, *INCX,  5, &info );
      PB_Cchkvec( ctxt, "PYCOPY", "Y", *N, 1, Yi, Yj, Yd, *INCY, 10, &info );
   }
   if( info ) { PB_Cabort( ctxt, "PYCOPY", info ); return; }
#endif
/*
