...
#else
void peswap_( N, X, IX, JX, DESCX, INCX, Y, IY, JY, DESCY, INCY )
/*
*  .. Scalar Arguments ..
*/
...
*/
   ...
   {
      PB_Cchkvec( ctxt, "PESWAP", "X", *N, 1, Xi, Xj, Xd, *INCX,  5, &info );
      PB_Cchkvec( ctxt, "PESWAP", "Y", *N, 1, Yi, Yj, Yd, *INCY, 10, &info );
   }
   if( info ) { PB_Cabort( ctxt, "PESWAP", info ); return; }
#endif
/*
...
*/
      type = PB_Cetypeset(); size = type->size;
/*
...
*/
            if( XmyprocR == XprocR )
            {
               ...
               if( XnpD > 0 )
               {
                  ...
                  if( XisRow )
                  {
                     Cegesd2d( ctxt, 1, XnpD, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, YprocR, dst );
                     Cegerv2d( ctxt, 1, XnpD, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, YprocR, dst );
                  }
                  else
                  {

                     Cegesd2d( ctxt, XnpD, 1, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, dst, YprocR );
                     Cegerv2d( ctxt, XnpD, 1, Mptr( ((char*) X), Xii, Xjj,
                               Xld, size ), Xld, dst, YprocR );
                  }
               }
            }
            if( YmyprocR == YprocR )
            {
               ...
               if( YnpD > 0 )
               {
                  ...
                  if( YisRow )
                  {
                     Cegesd2d( ctxt, 1, YnpD, Mptr( ((char*) Y), Yii, Yjj,
                               Yld, size ), Yld, XprocR, dst );
                     Cegerv2d( ctxt, 1, YnpD, Mptr( ((char*) Y), Yii, Yjj,
                               Yld, size ), Yld, XprocR, dst );
                  }
                  else
                  {
                     Cegesd2d( ctxt, YnpD, 1, Mptr( ((char*) Y), Yii, Yjj,
                               Yld, size ), Yld, dst, XprocR );
                     Cegerv2d( ctxt, YnpD, 1, Mptr( ((char*) Y), Yii, Yjj,
                               Yld, size ), Yld, dst, XprocR );
                  }
               }
            }
...
*/
               ...
               if( XnpD > 0 )
               {
                  ...
                  {
                     eswap_( &XnpD,  Mptr( ((char *) X), Xii, Xjj, Xld,
                  ...
                  {
                     if( XisRow )
                        Cegesd2d( ctxt, 1, XnpD, Mptr( ((char *) X), Xii,
                                  Xjj, Xld, size ), Xld, rdst, cdst );
                     else
                        Cegesd2d( ctxt, XnpD, 1, Mptr( ((char *) X), Xii,
                                  Xjj, Xld, size ), Xld, rdst, cdst );
                  }
               }
            }
...
*/
               ...
               if( YnpD > 0 )
               {
                  ...
                  if( ( myrow != rsrc ) || ( mycol != csrc ) )
                  {
                     ...
                     if( XisRow )
                        Cegerv2d( ctxt, 1, YnpD, buf,    1, rsrc, csrc );
                     else
                        Cegerv2d( ctxt, YnpD, 1, buf, YnpD, rsrc, csrc );
                     if( YisRow )
                        Cegesd2d( ctxt, 1, YnpD, Mptr( ((char *) Y), Yii,
                                  Yjj, Yld, size ), Yld, rsrc, csrc );
                     else
                        Cegesd2d( ctxt, YnpD, 1, Mptr( ((char *) Y), Yii,
                                  Yjj, Yld, size ), Yld, rsrc, csrc );
                     ecopy_( &YnpD, buf, &ione, Mptr( ((char *) Y), Yii,
                             Yjj, Yld, size ), &Ylinc );
                     if( buf ) free( buf );
                  }
               }
...
*/
               if( XnpD > 0 )
               {
                  if( ( myrow != rdst ) || ( mycol != cdst ) )
                  {
                     ...
                     if( YisRow )
                        Cegerv2d( ctxt, 1, XnpD, buf,    1, rdst, cdst );
                     else
                        Cegerv2d( ctxt, XnpD, 1, buf, XnpD, rdst, cdst );
                     ecopy_( &XnpD, buf, &ione, Mptr( ((char *) X), Xii,
                             Xjj, Xld, size ), &Xlinc );
                     if( buf ) free( buf );
                  }
               }
...
*/
                        if( ( XmyprocR == XprocR ) && ( XmyprocD == Xroc ) )
                        {
                           ...
                           Cegesd2d( ctxt, Xm, Xn, buf, Xm, rdst, cdst );
                           Cegerv2d( ctxt, Ym, Yn, buf, Ym, rdst, cdst );
                        ...
                        if( ( YmyprocR == YprocR ) && ( YmyprocD == Yroc  ) )
                        {
                           ...
                           PB_CVMpack( type, &VM, COLUMN, &Yscope, PACKING,
                                       ...
                                       Ym );
                           Cegesd2d( ctxt, Ym, Yn, buf, Ym, rsrc, csrc );
                           Cegerv2d( ctxt, Xm, Xn, buf, Xm, rsrc, csrc );
...
*/
         ...
         if( XnpD > 0 )
         {
            if( XisRow )
            {
               ...
               if( XmyprocR == XprocR )
                  Cegebs2d( ctxt, COLUMN, top, 1, XnpD, Mptr( ((char *) X),
                            Xii, Xjj, Xld, size ), Xld );
               else
                  Cegebr2d( ctxt, COLUMN, top, 1, XnpD, Mptr( ((char *) X),
            ...
            else
            {
               ...
               if( XmyprocR == XprocR )
                  Cegebs2d( ctxt, ROW,    top, XnpD, 1, Mptr( ((char *) X),
                            Xii, Xjj, Xld, size ), Xld );
               else
                  Cegebr2d( ctxt, ROW,    top, XnpD, 1, Mptr( ((char *) X),
...
*/
         ...
         if( YnpD > 0 )
         {
            if( YisRow )
            {
               top = PB_Ctop( &ctxt, BCAST, COLUMN, TOP_GET );
               if( YmyprocR == YprocR )
                  Cegebs2d( ctxt, COLUMN, top, 1, YnpD, Mptr( ((char *) Y),
                            Yii, Yjj, Yld, size ), Yld );
               else
                  Cegebr2d( ctxt, COLUMN, top, 1, YnpD, Mptr( ((char *) Y),
            ...
            else
            {
               top = PB_Ctop( &ctxt, BCAST, ROW,    TOP_GET );
               if( YmyprocR == YprocR )
                  Cegebs2d( ctxt, ROW,    top, YnpD, 1, Mptr( ((char *) Y),
                            Yii, Yjj, Yld, size ), Yld );
               else
                  Cegebr2d( ctxt, ROW,    top, YnpD, 1, Mptr( ((char *) Y),
...
*/
      PB_CpswapND( PB_Cetypeset(), *N, ((char *) X), Xi, Xj, Xd, *INCX,
...
*/
      PB_CpswapND( PB_Cetypeset(), *N, ((char *) Y), Yi, Yj, Yd, *INCY,
...
*/
      PB_CpswapNN( PB_Cetypeset(), *N, ((char *) X), Xi, Xj, Xd, *INCX,
                   ((char *) Y), Yi, Yj, Yd, *INCY );
   }
/*
*  End of PESWAP
