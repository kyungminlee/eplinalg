...
#else
void peaxpy_( N, ALPHA, X, IX, JX, DESCX, INCX, Y, IY, JY, DESCY, INCY )
/*
*  .. Scalar Arguments ..
*/
...
*  =======
*
*  PEAXPY  adds one subvector to another,
*
...
*/
   ...
   {
      PB_Cchkvec( ctxt, "PEAXPY", "X", *N, 1, Xi, Xj, Xd, *INCX,  6, &info );
      PB_Cchkvec( ctxt, "PEAXPY", "Y", *N, 1, Yi, Yj, Yd, *INCY, 11, &info );
   }
   if( info ) { PB_Cabort( ctxt, "PEAXPY", info ); return; }
#endif
/*
