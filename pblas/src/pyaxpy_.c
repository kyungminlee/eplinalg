...
#else
void pyaxpy_( N, ALPHA, X, IX, JX, DESCX, INCX, Y, IY, JY, DESCY, INCY )
/*
*  .. Scalar Arguments ..
*/
...
*  =======
*
*  PYAXPY  adds one subvector to another,
*
...
*/
   ...
   {
      PB_Cchkvec( ctxt, "PYAXPY", "X", *N, 1, Xi, Xj, Xd, *INCX,  6, &info );
      PB_Cchkvec( ctxt, "PYAXPY", "Y", *N, 1, Yi, Yj, Yd, *INCY, 11, &info );
   }
   if( info ) { PB_Cabort( ctxt, "PYAXPY", info ); return; }
#endif
/*
