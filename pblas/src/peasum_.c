...
#ifdef __STDC__
void peasum_( Int * N, EREAL * ASUM,
              EREAL * X, Int * IX, Int * JX, Int * DESCX, Int * INCX )
#else
void peasum_( N, ASUM, X, IX, JX, DESCX, INCX )
/*
*  .. Scalar Arguments ..
*/
   Int            * INCX, * IX, * JX, * N;
...
*  =======
*
*  PEASUM returns the sum of absolute values of the entries of a subvec-
*  tor sub( X ),
*
*  where
*
...
*/
   ...
   if( !( info = ( ( nprow == -1 ) ? -( 601 + CTXT_ ) : 0 ) ) )
      PB_Cchkvec( ctxt, "PEASUM", "X", *N, 1, Xi, Xj, Xd, *INCX, 6, &info );
   if( info ) { PB_Cabort( ctxt, "PEASUM", info ); return; }
#endif
/*
*  Initialize ASUM
*/
...
*/
         ...
         {
            Xld = Xd[LLD_];
            evasum_( &Xnq, ((char *) ASUM), ((char *)Mptr( X,Xii,Xjj,Xld,1 )),
                     &Xld );
         }
/*
