...
#ifdef __STDC__
void pytranu_( Int * M, Int * N,
               EREAL * ALPHA,
               EREAL * A, Int * IA, Int * JA, Int * DESCA,
               EREAL * BETA,
               EREAL * C, Int * IC, Int * JC, Int * DESCC )
#else
void pytranu_( M, N, ALPHA, A, IA, JA, DESCA, BETA, C, IC, JC, DESCC )
/*
*  .. Scalar Arguments ..
*/
   Int            * IA, * IC, * JA, * JC, * M, * N;
...
*/
   ...
   {
      PB_Cchkmat( ctxt, "PYTRANU", "A", *N, 2, *M, 1, Ai, Aj, Ad,  7, &info );
      PB_Cchkmat( ctxt, "PYTRANU", "C", *M, 1, *N, 2, Ci, Cj, Cd, 12, &info );
   }
   if( info ) { PB_Cabort( ctxt, "PYTRANU", info ); return; }
#endif
/*
