...
#if (INTFACE == C_CALL)
void Cygebs2d(Int ConTxt, char *scope, char *top, Int m, Int n, EREAL *A, Int lda)
#else
F_VOID_FUNC ygebs2d_(Int *ConTxt, F_CHAR scope, F_CHAR top, Int *m, Int *n,
                     EREAL *A, Int *lda)
#endif
/*
 *  -- V1.1 BLACS routine --
 ...
 *  Purpose
 *  =======
 *  Broadcast/send for general EREAL complex arrays.
 *
 *  Arguments
 *  =========
 *
