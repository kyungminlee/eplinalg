...
#if (INTFACE == C_CALL)
void Cytrrv2d(Int ConTxt, char *uplo, char *diag, Int m, Int n, EREAL *A,
              Int lda, Int rsrc, Int csrc)
#else
F_VOID_FUNC ytrrv2d_(Int *ConTxt, F_CHAR uplo, F_CHAR diag, Int *m, Int *n,
                     EREAL *A, Int *lda, Int *rsrc, Int *csrc)
#endif
/*
 *  -- V1.1 BLACS routine --
 ...
 *  Purpose
 *  =======
 *  Globally-blocking point to point trapezoidal EREAL complex receive.
 *
 *  Arguments
 *  =========
 *
