...
#if (INTFACE == C_CALL)
void Cytrbs2d(Int ConTxt, char *scope, char *top, char *uplo, char *diag,
              Int m, Int n, EREAL *A, Int lda)
#else
F_VOID_FUNC ytrbs2d_(Int *ConTxt, F_CHAR scope, F_CHAR top, F_CHAR uplo,
 ...
 *  Purpose
 *  =======
 *  Broadcast/send for trapezoidal EREAL complex arrays.
 *
 *  Arguments
 *  =========
 *
