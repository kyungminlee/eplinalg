...
#if (INTFACE == C_CALL)
void Cetrbs2d(Int ConTxt, char *scope, char *top, char *uplo, char *diag,
              Int m, Int n, EREAL *A, Int lda)
#else
F_VOID_FUNC etrbs2d_(Int *ConTxt, F_CHAR scope, F_CHAR top, F_CHAR uplo,
 ...
 *  Purpose
 *  =======
 *  Broadcast/send for trapezoidal EREAL precision arrays.
 *
 *  Arguments
 *  =========
 *
