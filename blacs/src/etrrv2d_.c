...
#if (INTFACE == C_CALL)
void Cetrrv2d(Int ConTxt, char *uplo, char *diag, Int m, Int n, EREAL *A,
              Int lda, Int rsrc, Int csrc)
#else
F_VOID_FUNC etrrv2d_(Int *ConTxt, F_CHAR uplo, F_CHAR diag, Int *m, Int *n,
 ...
 *  Purpose
 *  =======
 *  Globally-blocking point to point trapezoidal EREAL precision receive.
 *
 *  Arguments
 *  =========
 *
