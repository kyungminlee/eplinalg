...
#if (INTFACE == C_CALL)
void Cetrbr2d(Int ConTxt, char *scope, char *top, char *uplo, char *diag,
              Int m, Int n, EREAL *A, Int lda, Int rsrc, Int csrc)
#else
F_VOID_FUNC etrbr2d_(Int *ConTxt, F_CHAR scope, F_CHAR top, F_CHAR uplo,
 ...
 *  Purpose
 *  =======
 *  Broadcast/receive for trapezoidal EREAL precision arrays.
 *
 *  Arguments
 *  =========
 *
