...
#if (INTFACE == C_CALL)
void Cegamx2d(Int ConTxt, char *scope, char *top, Int m, Int n, EREAL *A,
              Int lda, Int *rA, Int *cA, Int ldia, Int rdest, Int cdest)
#else
F_VOID_FUNC egamx2d_(Int *ConTxt, F_CHAR scope, F_CHAR top, Int *m, Int *n,
 ...
 *  Purpose
 *  =======
 *  Combine amx operation for EREAL precision rectangular matrices.
 *
 *  Arguments
 *  =========
 *
 ...
 */
{
   ...
   void BI_eMPI_amx(void *, void *, MpiInt *, MPI_Datatype *);
   void BI_eMPI_amx2(void *, void *, MpiInt *, MPI_Datatype *);
/*
 ...
 */
   ...
   case ' ':         /* use MPI's reduction by default */
      ...
      if (Mpval(ldia) == -1)
      {
         ierr=MPI_Op_create(BI_eMPI_amx2, i, &BlacComb);
      }
      else
      {
         ierr=MPI_Op_create(BI_eMPI_amx, i, &BlacComb);
