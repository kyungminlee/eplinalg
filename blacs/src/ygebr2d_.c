...
#if (INTFACE == C_CALL)
void Cygebr2d(Int ConTxt, char *scope, char *top, Int m, Int n, EREAL *A,
              Int lda, Int rsrc, Int csrc)
#else
F_VOID_FUNC ygebr2d_(Int *ConTxt, F_CHAR scope, F_CHAR top, Int *m, Int *n,
 ...
 *  Purpose
 *  =======
 *  Broadcast/receive for general EREAL complex arrays.
 *
 *  Arguments
 *  =========
 *
