...
#if (INTFACE == C_CALL)
void Cytrbr2d(Int ConTxt, char *scope, char *top, char *uplo, char *diag,
              Int m, Int n, EREAL *A, Int lda, Int rsrc, Int csrc)
#else
F_VOID_FUNC ytrbr2d_(Int *ConTxt, F_CHAR scope, F_CHAR top, F_CHAR uplo,
                     F_CHAR diag, Int *m, Int *n, EREAL *A, Int *lda,
                     Int *rsrc, Int *csrc)
#endif
/*
 *  -- V1.1 BLACS routine --
 ...
 *  Purpose
 *  =======
 *  Broadcast/receive for trapezoidal EREAL complex arrays.
 *
 *  Arguments
 *  =========
 *
