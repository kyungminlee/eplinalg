...
#if (INTFACE == C_CALL)
void Cegesd2d(Int ConTxt, Int m, Int n, EREAL *A, Int lda,
              Int rdest, Int cdest)
#else
F_VOID_FUNC egesd2d_(Int *ConTxt, Int *m, Int *n, EREAL *A, Int *lda,
                     Int *rdest, Int *cdest)
#endif
/*
 *  -- V1.1 BLACS routine --
 ...
 *  Purpose
 *  =======
 *  Locally-blocking point-to-point general EREAL precision send.
 *
 *  Arguments
 *  =========
 *
...
#if (BlacsDebugLvl > 0)
   BI_ArgCheck(Mpval(ConTxt), RT_SD, "EGESD2D", 'a', 'u', 'u', Mpval(m),
