...
#if (INTFACE == C_CALL)
void Cygesd2d(Int ConTxt, Int m, Int n, EREAL *A, Int lda,
              Int rdest, Int cdest)
#else
F_VOID_FUNC ygesd2d_(Int *ConTxt, Int *m, Int *n, EREAL *A, Int *lda,
                     Int *rdest, Int *cdest)
#endif
/*
 *  -- V1.1 BLACS routine --
 ...
 *  Purpose
 *  =======
 *  Locally-blocking point-to-point general EREAL complex send.
 *
 *  Arguments
 *  =========
 *
...
#if (BlacsDebugLvl > 0)
   BI_ArgCheck(Mpval(ConTxt), RT_SD, "YGESD2D", 'a', 'u', 'u', Mpval(m),
