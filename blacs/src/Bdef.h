...
/*
 *  Extended-precision types for migrated e/y routines.
 */
typedef long double EREAL;
typedef struct {EREAL r, i;} ECOMPLEX;

void BI_emvcopy(Int m, Int n, EREAL *A, Int lda, EREAL *buff);
void BI_evmcopy(Int m, Int n, EREAL *A, Int lda, EREAL *buff);
...
#define BI_ymvcopy(m, n, A, lda, buff) \
        BI_emvcopy(2*(m), (n), (EREAL *) (A), 2*(lda), (EREAL *) (buff))
#define BI_yvmcopy(m, n, A, lda, buff) \
        BI_evmcopy(2*(m), (n), (EREAL *) (A), 2*(lda), (EREAL *) (buff))
