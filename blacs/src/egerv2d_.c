...
#if (INTFACE == C_CALL)
void Cegerv2d(Int ConTxt, Int m, Int n, EREAL *A, Int lda, Int rsrc, Int csrc)
#else
F_VOID_FUNC egerv2d_(Int *ConTxt, Int *m, Int *n, EREAL *A, Int *lda,
                     Int *rsrc, Int *csrc)
#endif
/*
 *  -- V1.1 BLACS routine --
 ...
 *  Purpose
 *  =======
 *  Globally-blocking point to point general EREAL precision receive.
 *
 *  Arguments
 *  =========
 *
