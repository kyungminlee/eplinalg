...
#if (INTFACE == C_CALL)
void Cegebr2d(Int ConTxt, char *scope, char *top, Int m, Int n, EREAL *A,
              Int lda, Int rsrc, Int csrc)
#else
F_VOID_FUNC egebr2d_(Int *ConTxt, F_CHAR scope, F_CHAR top, Int *m, Int *n,
 ...
 *  Purpose
 *  =======
 *  Broadcast/receive for general EREAL precision arrays.
 *
 *  Arguments
 *  =========
 *
