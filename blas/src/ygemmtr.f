...
*  ===========
*
*       SUBROUTINE YGEMMTR(UPLO,TRANSA,TRANSB,N,K,ALPHA,A,LDA,B,LDB,BETA,
*                         C,LDC)
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> YGEMMTR  performs one of the matrix-matrix operations
*>
...
*> \param[in] A
*> \verbatim
*>          A is COMPLEX(KIND=10) array, dimension ( LDA, ka ), where ka is
...
*> \param[in] B
*> \verbatim
*>          B is COMPLEX(KIND=10) array, dimension ( LDB, kb ), where kb is
...
*>
*  =====================================================================
      SUBROUTINE YGEMMTR(UPLO,TRANSA,TRANSB,N,K,ALPHA,A,LDA,B,LDB,      
     +    BETA,C,LDC)
      IMPLICIT NONE
*
