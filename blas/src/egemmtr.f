...
*  ===========
*
*       SUBROUTINE EGEMMTR(UPLO,TRANSA,TRANSB,N,K,ALPHA,A,LDA,B,LDB,BETA,
*                         C,LDC)
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> EGEMMTR  performs one of the matrix-matrix operations
*>
...
*> \param[in] A
*> \verbatim
*>          A is REAL(KIND=10) array, dimension ( LDA, ka ), where ka is
...
*> \param[in] B
*> \verbatim
*>          B is REAL(KIND=10) array, dimension ( LDB, kb ), where kb is
...
*>
*  =====================================================================
      SUBROUTINE EGEMMTR(UPLO,TRANSA,TRANSB,N,K,ALPHA,A,LDA,B,LDB,      
     +    BETA,C,LDC)
      IMPLICIT NONE
*
