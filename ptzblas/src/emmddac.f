      SUBROUTINE EMMDDAC( M, N, ALPHA, A, LDA, BETA, B, LDB )
      IMPLICIT NONE
*
...
*  =======
*
*  EMMDDAC performs the following operation:
*
*     A := alpha * A + beta * B,
*
...
*  10          CONTINUE
   ...
   40       CONTINUE
         ELSE
            DO 60 J = 1, N
               CALL EAXPY( M, ONE, B( 1, J ), 1, A( 1, J ), 1 )
*              DO 50 I = 1, M
*                 A( I, J ) = B( I, J ) + A( I, J )
*  50          CONTINUE
   60       CONTINUE
  ...
  100       CONTINUE
         ELSE
            DO 120 J = 1, N
               CALL EAXPY( M, BETA, B( 1, J ), 1, A( 1, J ), 1 )
*              DO 110 I = 1, M
