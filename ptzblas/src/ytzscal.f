      SUBROUTINE YTZSCAL( UPLO, M, N, IOFFD, ALPHA, A, LDA )
      IMPLICIT NONE
*
...
*  =======
*
*  YTZSCAL scales a two-dimensional array A by the scalar alpha.
*
*  Arguments
*  =========
*
...
*
   ...
   10    CONTINUE
         DO 20 J = MN + 1, MIN( M - IOFFD, N )
            JTMP = J + IOFFD
            IF( M.GE.JTMP )          CALL YSCAL( M-JTMP+1, ALPHA, A( 
     +JTMP, J ), 1 )
   20    CONTINUE
*
...
*
         ...
         DO 30 J = MAX( 0, -IOFFD ) + 1, MN
            CALL YSCAL( J + IOFFD, ALPHA, A( 1, J ), 1 )
   30    CONTINUE
