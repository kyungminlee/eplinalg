      SUBROUTINE EAGEMV( TRANS, M, N, ALPHA, A, LDA, X, INCX, BETA, Y,  
     +                  INCY )
      IMPLICIT NONE
*
...
*  =======
*
*  EAGEMV performs one of the matrix-vector operations
*
...
*
*  A       (input) REAL(KIND=10) array of dimension ( LDA, n ).
