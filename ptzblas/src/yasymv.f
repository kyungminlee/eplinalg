      SUBROUTINE YASYMV( UPLO, N, ALPHA, A, LDA, X, INCX, BETA, Y,      
     +              INCY )
      IMPLICIT NONE
*
...
*  =======
*
*  YASYMV performs the following matrix-vector operation
*
