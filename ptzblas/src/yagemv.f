      SUBROUTINE YAGEMV( TRANS, M, N, ALPHA, A, LDA, X, INCX, BETA, Y,  
     +                  INCY )
      IMPLICIT NONE
*
...
*  =======
*
*  YAGEMV performs one of the matrix-vector operations
*
...
*
*  A       (input) COMPLEX(KIND=10) array of dimension ( LDA, n ).
