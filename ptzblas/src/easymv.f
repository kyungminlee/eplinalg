      SUBROUTINE EASYMV( UPLO, N, ALPHA, A, LDA, X, INCX, BETA, Y,      
     +              INCY )
      IMPLICIT NONE
*
...
*     .. Local Scalars ..
      ...
      REAL(KIND=10)   TALPHA, TEMP0, TEMP1, TEMP2
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      EXTERNAL           LSAME
