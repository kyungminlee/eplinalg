      SUBROUTINE EVVDOT( N, DOT, X, INCX, Y, INCY )
      IMPLICIT NONE
*
...
*  =======
*
*  EVVDOT computes the following dot product:
*
*     dot = dot + x**T * y,
*
...
*
*  Y       (input) REAL(KIND=10) array of dimension at least
