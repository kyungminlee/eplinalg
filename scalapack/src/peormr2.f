      SUBROUTINE PEORMR2( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,  
...
*  =======
*
*  PEORMR2 overwrites the general real M-by-N distributed matrix
...
*     .. External Subroutines ..
     ...
     +                   PEELSET2, PELARF, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEORMR2', -INFO )
...
*        Apply H(i) or H(i)'
*
         CALL PEELSET2( AII, A, I, JA+NQ-K+I-IA, DESCA, ONE )
         CALL PELARF( SIDE, MI, NI, A, I, JA, DESCA, DESCA( M_ ),       
     +          TAU, C, IC, JC, DESCC, WORK )
         CALL PEELSET( A, I, JA+NQ-K+I-IA, DESCA, AII )
*
   10 CONTINUE
*
