      SUBROUTINE YPTTRSV( UPLO, TRANS, N, NRHS, D, E, B, LDB,           
     +              INFO )
      IMPLICIT NONE
*
...
*          factorization computed by YPTTRF.
*
