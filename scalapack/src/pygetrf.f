...
*  =======
*
*  PYGETRF computes an LU factorization of a general M-by-N distributed
...
*     .. External Subroutines ..
     ...
     +                PB_TOPGET, PB_TOPSET, PYGEMM, PYGETF2,            
     +        PYLASWP, PYTRSM, PXERBLA
*     ..
*     .. External Functions ..
      INTEGER            ICEIL
      EXTERNAL           ICEIL
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYGETRF', -INFO )
         RETURN
      END IF
*
...
*     singularity.
*
      CALL PYGETF2( M, JB, A, IA, JA, DESCA, IPIV, INFO )
*
      IF( JB+1.LE.N ) THEN
*
*        Apply interchanges to columns JN+1:JA+N-1.
*
         CALL PYLASWP( 'Forward', 'Rows', N-JB, A, IA, JN+1, DESCA,     
     +             IA, IN, IPIV )
*
*        Compute block row of U.
*
         CALL PYTRSM( 'Left', 'Lower', 'No transpose', 'Unit', JB,      
...
*
            CALL PYGEMM( 'No transpose', 'No transpose', M-JB, N-JB, JB,
...
*        singularity.
*
         CALL PYGETF2( M-J+JA, JB, A, I, J, DESCA, IPIV, IINFO )
*
...
*
         CALL PYLASWP( 'Forward', 'Rowwise', J-JA, A, IA, JA, DESCA,    
     +              I, I+JB-1, IPIV )
*
...
*
            CALL PYLASWP( 'Forward', 'Rowwise', N-J-JB+JA, A, IA, J+JB, 
     +                    DESCA, I, I+JB-1, IPIV )
*
*           Compute block row of U.
*
...
*              Update trailing submatrix.
*
               CALL PYGEMM( 'No transpose', 'No transpose', M-J-JB+JA,  
