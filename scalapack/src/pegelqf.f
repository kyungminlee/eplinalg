      SUBROUTINE PEGELQF( M, N, A, IA, JA, DESCA, TAU, WORK, LWORK,     
     +                INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PEGELQF computes a LQ factorization of a real distributed M-by-N
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK1MAT, PEGELQ2,    
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEGELQF', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      CALL PEGELQ2( IB, N, A, IA, JA, DESCA, TAU, WORK, LWORK, IINFO )
*
...
*
         CALL PELARFB( 'Right', 'No transpose', 'Forward', 'Rowwise',   
...
*        A(i:i+ib-1:j:ja+n-1)
*
         CALL PEGELQ2( IB, N-I+IA, A, I, J, DESCA, TAU, WORK, LWORK,    
     +              IINFO )
*
