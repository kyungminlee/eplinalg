      SUBROUTINE PYLAPV2( DIREC, ROWCOL, M, N, A, IA, JA, DESCA, IPIV,  
     +                   IP, JP, DESCIP )
      IMPLICIT NONE
*
...
*  =======
*
*  PYLAPV2 applies either P (permutation matrix indicated by IPIV)
...
*
               DO 40 K = J, J+JB-1
                  JP1 = IPIV( ITMP ) - JP + JA
                  IF( JP1.NE.K )                CALL PYSWAP( M, A, IA, 
