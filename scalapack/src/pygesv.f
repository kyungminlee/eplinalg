      SUBROUTINE PYGESV( N, NRHS, A, IA, JA, DESCA, IPIV, B, IB, JB,    
     +                DESCB, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYGESV computes the solution to a complex system of linear equations
*
*                        sub( A ) * X = sub( B ),
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK2MAT, PYGETRF,    
     +                PYGETRS, PXERBLA
*     ..
*     .. External Functions ..
      INTEGER            INDXG2P
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYGESV', -INFO )
         RETURN
      END IF
*
*     Compute the LU factorization of sub( A ).
*
      CALL PYGETRF( N, N, A, IA, JA, DESCA, IPIV, INFO )
*
      IF( INFO.EQ.0 ) THEN
*
...
*        with X.
*
         CALL PYGETRS( 'No transpose', N, NRHS, A, IA, JA, DESCA, IPIV, 
     +                 B, IB, JB, DESCB, INFO )
*
      END IF
*
