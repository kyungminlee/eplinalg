      SUBROUTINE PYUNMQR( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,  
...
*  =======
*
*  PYUNMQR overwrites the general complex M-by-N distributed matrix
...
*     .. External Subroutines ..
     ...
     +                PYLARFT, PYUNM2R, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYUNMQR', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
     ...
     +  CALL PYUNM2R( SIDE, TRANS, M, N, J1-JA, A, IA, JA, DESCA, TAU,  
...
*
         CALL PYLARFT( 'Forward', 'Columnwise', NQ-J+JA, JB, A,         
...
*        Apply H or H'
*
         CALL PYLARFB( SIDE, TRANS, 'Forward', 'Columnwise', MI, NI,    
...
*
     ...
     +  CALL PYUNM2R( SIDE, TRANS, M, N, J2-JA, A, IA, JA, DESCA, TAU,  
     +                C, IC, JC, DESCC, WORK, LWORK, IINFO )
*
