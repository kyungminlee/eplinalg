      SUBROUTINE PYLAPIV( DIREC, ROWCOL, PIVROC, M, N, A, IA, JA,       
...
*  =======
*
*  PYLAPIV applies either P (permutation matrix indicated by IPIV)
...
*     .. External Subroutines ..
     ...
     +      INFOG2L, PYLAPV2, PICOL2ROW, PIROW2COL
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
         IF( LSAME( PIVROC, 'C' ) ) THEN
            CALL PYLAPV2( DIREC, ROWCOL, M, N, A, IA, JA, DESCA, IPIV,  
     +                   IP, JP, DESCIP )
*
*        Otherwise, we must redistribute IPIV to match PYLAPV2
*
         ELSE
*
...
*
   ...
   10       CONTINUE
            CALL PYLAPV2( DIREC, ROWCOL, M, N, A, IA, JA, DESCA, IWORK, 
     +                    IPT, 1, DESCPT )
         END IF
*
