      SUBROUTINE PELAQGE( M, N, A, IA, JA, DESCA, R, C, ROWCND, COLCND, 
     +                    AMAX, EQUED )
      IMPLICIT NONE
*
...
*  =======
*
*  PELAQGE equilibrates a general M-by-N distributed matrix
...
*
*  R       (local input) REAL(KIND=10) array, dimension LOCr(M_A)
...
*
*  C       (local input) REAL(KIND=10) array, dimension LOCc(N_A)
...
*
      SMALL = PELAMCH( ICTXT, 'Safe minimum' ) /         PELAMCH( ICTXT,
     + 'Precision' )
      LARGE = ONE / SMALL
*
