      SUBROUTINE PEGETF2( M, N, A, IA, JA, DESCA, IPIV, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PEGETF2 computes an LU factorization of a general M-by-N
...
*     .. External Subroutines ..
     ...
     +                   IGEBS2D, INFOG2L, PEAMAX, PEGER,               
     +     PESCAL, PESWAP, PB_TOPGET, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN, MOD
*     ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEGETF2', -INFO )
...
*
            IF( J-JA+1.LT.MN ) THEN
               CALL PEGER( M-J+JA-1, N-J+JA-1, -ONE, A, I+1, J, DESCA,  
