      SUBROUTINE YDTTRSV( UPLO, TRANS, N, NRHS, DL, D, DU,              
     +      B, LDB, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  YDTTRSV solves one of the systems of equations
...
*
     ...
     +) )*B( 1, J ) ) /                      CONJG( D( 2 ) )
            DO 70 I = 3, N
               B( I, J ) = ( B( I, J )                      -CONJG( DU( 
     +I-1 ) )*B( I-1, J ) ) /                      CONJG( D( I ) )
   70       CONTINUE
   95    CONTINUE
*
         ELSE
