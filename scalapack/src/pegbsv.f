      SUBROUTINE PEGBSV( N, BWL, BWU, NRHS, A, JA, DESCA, IPIV, B, IB,  
...
*  =======
*
*  PEGBSV solves a system of linear equations
*
...
*
*  See PEGBTRF and PEGBTRS for details.
*
*  =====================================================================
*
*  Arguments
...
*     .. External Subroutines ..
      EXTERNAL           PEGBTRF, PEGBTRS, PXERBLA
*     ..
...
*
      ...
      ELSE
         INFO = -( 6*100 + DTYPE_ )
         CALL PXERBLA( ICTXT,       'PEGBSV',       -INFO )
         RETURN
      ENDIF
*
...
*     Factor the matrix
*
      CALL PEGBTRF( N, BWL, BWU, A, JA, DESCA, IPIV, WORK,              
...
*
      CALL PEGBTRS( 'N', N, BWL, BWU, NRHS, A, JA, DESCA, IPIV, B, IB,  
