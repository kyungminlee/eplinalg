      SUBROUTINE ELASORTE( S, LDS, J, OUT, INFO )
      IMPLICIT NONE
*
...
*     ..
*     .. Array Arguments ..
      REAL(KIND=10)   OUT( J, * ), S( LDS, * )
*     ..
*
*  Purpose
*  =======
*
*  ELASORTE sorts eigenpairs so that real eigenpairs are together and
...
*  =========
*
*  S       (local input/output) REAL(KIND=10) array, dimension LDS
...
*          Unchanged on exit.
*
*  OUT     (local input/output) REAL(KIND=10) array, dimension Jx2
