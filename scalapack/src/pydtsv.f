      SUBROUTINE PYDTSV( N, NRHS, DL, D, DU, JA, DESCA, B, IB, DESCB,   
     +                 WORK, LWORK, INFO )
      IMPLICIT NONE
*
*
...
*  =======
*
*  PYDTSV solves a system of linear equations
*
...
*
*  See PYDTTRF and PYDTTRS for details.
*
*  =====================================================================
*
*  Arguments
...
*     .. External Subroutines ..
      EXTERNAL           PYDTTRF, PYDTTRS, PXERBLA
*     ..
...
*
      ...
      ELSE
         INFO = -( 6*100 + DTYPE_ )
         CALL PXERBLA( ICTXT,       'PYDTSV',       -INFO )
         RETURN
      ENDIF
*
...
*     Factor the matrix
*
      CALL PYDTTRF( N, DL, D, DU, JA, DESCA, WORK,               MIN( 
...
*
      CALL PYDTTRS( 'N', N, NRHS, DL, D, DU, JA, DESCA, B, IB, DESCB,   
