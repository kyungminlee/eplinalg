      SUBROUTINE PYPBSV( UPLO, N, BW, NRHS, A, JA, DESCA, B, IB, DESCB, 
     +                   WORK, LWORK, INFO )
      IMPLICIT NONE
*
*
...
*  =======
*
*  PYPBSV solves a system of linear equations
*
...
*  the matrix into L L'.
*
*  See PYPBTRF and PYPBTRS for details.
*
*  =====================================================================
*
*  Arguments
...
*     .. External Subroutines ..
      EXTERNAL           PYPBTRF, PYPBTRS, PXERBLA
*     ..
...
*
      ...
      ELSE
         INFO = -( 6*100 + DTYPE_ )
         CALL PXERBLA( ICTXT,       'PYPBSV',       -INFO )
         RETURN
      ENDIF
*
...
*     Factor the matrix
*
      CALL PYPBTRF( UPLO, N, BW, A, JA, DESCA, WORK,               MIN( 
...
*
      CALL PYPBTRS( UPLO, N, BW, NRHS, A, JA, DESCA, B, IB, DESCB, WORK,
