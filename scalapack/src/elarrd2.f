      SUBROUTINE ELARRD2( RANGE, ORDER, N, VL, VU, IL, IU, GERS,        
...
*  =======
*
*  ELARRD2 computes the eigenvalues of a symmetric tridiagonal
*  matrix T to limited initial accuracy. This is an auxiliary code to be 
*  called from ELARRE2A.
* 
*  ELARRD2 has been created using the LAPACK code ELARRD
*  which itself stems from ESTEBZ. The motivation for creating
*  ELARRD2 is efficiency: When computing eigenvalues in parallel
*  and the input tridiagonal matrix splits into blocks, ELARRD2 
...
*
*  D       (input) REAL(KIND=10) array, dimension (N)
*          The n diagonal elements of the tridiagonal matrix T.
*
*  E       (input) REAL(KIND=10) array, dimension (N-1)
*          The (n-1) off-diagonal elements of the tridiagonal matrix T.
*
*  E2      (input) REAL(KIND=10) array, dimension (N-1)
...
*          eigenvalue approximations. ELARRD2 computes an interval 
...
*          belongs.  (ELARRD2 may use the remaining N-M elements as
*          workspace.)
*
...
*
*  WORK    (workspace) REAL(KIND=10) array, dimension (4*N)
*
...
*  ===================
*
*  FUDGE   REAL(KIND=10), default = 2 originally, increased to 10.
...
*     .. Local Scalars ..
     ...
     $                   JEE, NB, NWL, NWU
      REAL(KIND=10)   ATOLI, EPS, GL, GU, RTOLI, SPDIAM, TMP1, TMP2,    
...
*           Compute Eigenvalues
     ...
     $              LOG( TWO ) ) + 2
            CALL ELAEBZ( 2, ITMAX, IN, IN, 1, NB, ATOLI, RTOLI, PIVMIN, 
     +                   D( IBEGIN ), E( IBEGIN ), E2( IBEGIN ),        
