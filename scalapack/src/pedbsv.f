      SUBROUTINE PEDBSV( N, BWL, BWU, NRHS, A, JA, DESCA, B, IB, DESCB, 
     +                   WORK, LWORK, INFO )
      IMPLICIT NONE
*
*
...
*  =======
*
*  PEDBSV solves a system of linear equations
*
...
*
*  See PEDBTRF and PEDBTRS for details.
*
*  =====================================================================
*
*  Arguments
...
*     .. External Subroutines ..
      EXTERNAL           PEDBTRF, PEDBTRS, PXERBLA
*     ..
...
*
      ...
      ELSE
         INFO = -( 6*100 + DTYPE_ )
         CALL PXERBLA( ICTXT,       'PEDBSV',       -INFO )
         RETURN
      ENDIF
*
...
*
      WS_FACTOR = NB*(BWL+BWU)+6*MAX(BWL,BWU)*MAX(BWL,BWU)
*
*     Factor the matrix
*
      CALL PEDBTRF( N, BWL, BWU, A, JA, DESCA, WORK,               MIN( 
...
*
      CALL PEDBTRS( 'N', N, BWL, BWU, NRHS, A, JA, DESCA, B, IB, DESCB, 
