      SUBROUTINE PEORMTR( SIDE, UPLO, TRANS, M, N, A, IA, JA, DESCA,    
...
*  =======
*
*  PEORMTR overwrites the general real M-by-N distributed matrix
...
*  product of nq-1 elementary reflectors, as returned by PESYTRD:
*
...
*          define the elementary reflectors, as returned by PESYTRD.
...
*
*  TAU     (local input) REAL(KIND=10) array, dimension LTAU, where
...
*          reflector H(i), as returned by PESYTRD. TAU is tied to the
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK2MAT, PEORMQL,    
     +                PEORMQR, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEORMTR', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      IF( UPPER ) THEN
*
*        Q was determined by a call to PESYTRD with UPLO = 'U'
*
         CALL PEORMQL( SIDE, TRANS, MI, NI, NQ-1, A, IAA, JAA, DESCA,   
     +               TAU, C, ICC, JCC, DESCC, WORK, LWORK, IINFO )
*
      ELSE
*
*        Q was determined by a call to PESYTRD with UPLO = 'L'
*
         CALL PEORMQR( SIDE, TRANS, MI, NI, NQ-1, A, IAA, JAA, DESCA,   
     +               TAU, C, ICC, JCC, DESCC, WORK, LWORK, IINFO )
*
      END IF
*
