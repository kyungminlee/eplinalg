      SUBROUTINE PYGETF2( M, N, A, IA, JA, DESCA, IPIV, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYGETF2 computes an LU factorization of a general M-by-N
...
*     .. Local Scalars ..
     ...
     $                   JJA, MN, MYCOL, MYROW, NPCOL, NPROW
      COMPLEX(KIND=10)            GMAX
*     ..
*     .. External Subroutines ..
      EXTERNAL           BLACS_ABORT, BLACS_GRIDINFO, CHK1MAT, IGEBR2D, 
     +                   IGEBS2D, INFOG2L, PYAMAX, PYGERU,              
     +      PYSCAL, PYSWAP, PB_TOPGET, PXERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN, MOD
*     ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYGETF2', -INFO )
...
*
            IF( J-JA+1.LT.MN ) THEN
               CALL PYGERU( M-J+JA-1, N-J+JA-1, -ONE, A, I+1, J, DESCA, 
