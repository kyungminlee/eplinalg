*
*
      SUBROUTINE PELAEVSWP( N, ZIN, LDZI, Z, IZ, JZ, DESCZ, NVS, KEY,   
     +                    WORK, LWORK )
      IMPLICIT NONE
*
...
*     .. Array Arguments ..
      ...
      REAL(KIND=10)   WORK( * ), Z( * ), ZIN( LDZI, * )
*     ..
*
*  Purpose
*  =======
*
*  PELAEVSWP moves the eigenvectors (potentially unsorted) from
...
*
*  ZIN     (local input) REAL(KIND=10) array,
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, EGERV2D, EGESD2D
*     ..
*     .. Intrinsic Functions ..
...
*
*
         IF( MYROW.NE.SENDROW .OR. MYCOL.NE.SENDCOL )       CALL 
     +EGESD2D( DESCZ( CTXT_ ), NBUFSIZE, 1, WORK, NBUFSIZE,             
     +        SENDROW, SENDCOL )
*
*
...
*
*
         IF( MYROW.NE.RECVROW .OR. MYCOL.NE.RECVCOL )       CALL 
     +EGERV2D( DESCZ( CTXT_ ), 1, NBUFSIZE, WORK, 1, RECVROW,           
     +          RECVCOL )
*
         NBUFSIZE = 0
