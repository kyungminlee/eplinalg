      SUBROUTINE PYUNMLQ( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,  
...
*  =======
*
*  PYUNMLQ overwrites the general complex M-by-N distributed matrix
...
*     .. External Subroutines ..
     ...
     +                PYLARFT, PYUNML2, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYUNMLQ', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
     ...
     +  CALL PYUNML2( SIDE, TRANS, M, N, I1-IA, A, IA, JA, DESCA, TAU,  
...
*
         CALL PYLARFT( 'Forward', 'Rowwise', NQ-I+IA, IB, A, I, JA+I-IA,
...
*        Apply H or H'
*
         CALL PYLARFB( SIDE, TRANST, 'Forward', 'Rowwise', MI, NI, IB,  
     +                A, I, JA+I-IA, DESCA, WORK, C, ICC, JCC, DESCC,   
     +               WORK( IPW ) )
   10 CONTINUE
*
      IF( ( LEFT .AND. .NOT.NOTRAN ) .OR. ( .NOT.LEFT .AND. NOTRAN ) )  
     +  CALL PYUNML2( SIDE, TRANS, M, N, I2-IA, A, IA, JA, DESCA, TAU,  
     +                C, IC, JC, DESCC, WORK, LWORK, IINFO )
*
