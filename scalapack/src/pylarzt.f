      SUBROUTINE PYLARZT( DIRECT, STOREV, N, K, V, IV, JV, DESCV, TAU,  
     +                   T, WORK )
      IMPLICIT NONE
*
...
*  =======
*
*  PYLARZT forms the triangular factor T of a complex block reflector
*  H of order > n, which is defined as a product of k elementary
*  reflectors as returned by PYTZRZF.
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_ABORT, BLACS_GRIDINFO, YCOPY, YGEMV,     
     +               YGSUM2D, YLACGV, YLASET, YTRMV,                    
     +INFOG2L, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYLARZT', -INFO )
...
*
            ITMP0 = ITMP0 + 1
            IF( NQ.GT.0 ) THEN
               CALL YLACGV( NQ, V( II+(JJV-1)*LDV ), LDV )
               CALL YGEMV( 'No transpose', ITMP0, NQ, -TAU( II ),       
...
*
               ...
               IW = IW + ITMP0
*
               CALL YTRMV( 'Lower', 'No transpose', 'Non-unit', ITMP0,  
