      SUBROUTINE PEGELQ2( M, N, A, IA, JA, DESCA, TAU, WORK, LWORK,     
     +                INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PEGELQ2 computes a LQ factorization of a real distributed M-by-N
...
*     .. External Subroutines ..
     ...
     +                   PELARF, PELARFG, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEGELQ2', -INFO )
...
*        A(i,j+1:ja+n-1)
*
         CALL PELARFG( N-J+JA, AII, I, J, A, I, MIN( J+1, JA+N-1 ),     
     +             DESCA, DESCA( M_ ), TAU )
*
         IF( I.LT.IA+M-1 ) THEN
*
