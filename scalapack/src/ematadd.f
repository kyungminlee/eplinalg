      SUBROUTINE EMATADD( M, N, ALPHA, A, LDA, BETA, C, LDC )
      IMPLICIT NONE
*
...
*     ..
*     .. Array Arguments ..
      REAL(KIND=10)   A( LDA, * ), C( LDC, * )
*     ..
*
*  Purpose
*  =======
*
*  EMATADD performs the following local matrix-matrix operation
*
*               C := alpha * A + beta * C,
*
...
*          The scalar BETA.
*
*  C       (local input/local output) REAL(KIND=10)
