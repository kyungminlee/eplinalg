      SUBROUTINE PYERSCL( N, SA, SX, IX, JX, DESCX, INCX )
      IMPLICIT NONE
*
...
*  =======
*
*  PYERSCL multiplies an N-element complex distributed vector
...
*     .. Local Scalars ..
      ...
      REAL(KIND=10)               BIGNUM, CDEN, CDEN1, CNUM, CNUM1, MUL,
     + SMLNUM
*     ..
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, PYESCAL, PELABAD
*     ..
*     .. External Functions ..
...
*
      CALL PYESCAL( N, MUL, SX, IX, JX, DESCX, INCX )
*
      IF( .NOT.DONE )
     $   GO TO 10
*
