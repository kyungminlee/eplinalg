      SUBROUTINE PEGESV( N, NRHS, A, IA, JA, DESCA, IPIV, B, IB, JB,    
     +                DESCB, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PEGESV computes the solution to a real system of linear equations
*
*                        sub( A ) * X = sub( B ),
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK2MAT, PEGETRF,    
     +                PEGETRS, PXERBLA
*     ..
*     .. External Functions ..
      INTEGER            INDXG2P
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEGESV', -INFO )
         RETURN
      END IF
*
*     Compute the LU factorization of sub( A ).
*
      CALL PEGETRF( N, N, A, IA, JA, DESCA, IPIV, INFO )
*
      IF( INFO.EQ.0 ) THEN
*
...
*        with X.
*
         CALL PEGETRS( 'No transpose', N, NRHS, A, IA, JA, DESCA, IPIV, 
     +                 B, IB, JB, DESCB, INFO )
*
      END IF
*
