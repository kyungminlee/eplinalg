*
*
      SUBROUTINE PYLAEVSWP( N, ZIN, LDZI, Z, IZ, JZ, DESCZ, NVS, KEY,   
     +                    RWORK, LRWORK )
      IMPLICIT NONE
*
...
*  =======
*
*  PYLAEVSWP moves the eigenvectors (potentially unsorted) from
...
*
     ...
     +EGESD2D( DESCZ( CTXT_ ), NBUFSIZE, 1, RWORK, NBUFSIZE,            
     +         SENDROW, SENDCOL )
*
*
...
*
     ...
     +EGERV2D( DESCZ( CTXT_ ), 1, NBUFSIZE, RWORK, 1,                   
     +  RECVROW, RECVCOL )
*
         NBUFSIZE = 0
