      SUBROUTINE PEORML2( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,  
...
*  =======
*
*  PEORML2 overwrites the general real M-by-N distributed matrix
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEORML2', -INFO )
...
*        Apply H(i) or H(i)'
*
         CALL PEELSET2( AII, A, I, JA+I-IA, DESCA, ONE )
         CALL PELARF( SIDE, MI, NI, A, I, JA+I-IA, DESCA, DESCA( M_ ),  
     +               TAU, C, ICC, JCC, DESCC, WORK )
         CALL PEELSET( A, I, JA+I-IA, DESCA, AII )
*
   10 CONTINUE
*
