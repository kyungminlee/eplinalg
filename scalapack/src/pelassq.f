      SUBROUTINE PELASSQ( N, X, IX, JX, DESCX, INCX, SCALE, SUMSQ )
      IMPLICIT NONE
*
...
*  =======
*
*  PELASSQ  returns the values  scl  and  smsq  such that
*
...
*
*  SCALE   (local input/local output) REAL(KIND=10)
*          On entry, the value  scale  in the equation above.
*          On exit, SCALE is overwritten with  scl , the scaling factor
*          for the sum of squares.
*
*  SUMSQ   (local input/local output) REAL(KIND=10)
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, ECOMBSSQ, INFOG2L, PETREECOMB
*     ..
*     .. External Functions ..
      INTEGER            NUMROC
      EXTERNAL           NUMROC
...
*
     ...
     $      NQ = NQ - ICOFF
*
*        Code direct from LAPACK's ELASSQ, (save subroutine call)
*
         IF( NQ.GT.0 ) THEN
            IOFF = IIX + ( JJX - 1 ) * LDX
            DO 10 I = 1, NQ
