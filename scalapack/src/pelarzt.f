      SUBROUTINE PELARZT( DIRECT, STOREV, N, K, V, IV, JV, DESCV, TAU,  
     +                   T, WORK )
      IMPLICIT NONE
*
...
*  =======
*
*  PELARZT forms the triangular factor T of a real block reflector
*  H of order > n, which is defined as a product of k elementary
*  reflectors as returned by PETZRZF.
*
...
*
*  T       (local output) REAL(KIND=10) array, dimension (MB_V,MB_V)
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_ABORT, BLACS_GRIDINFO, ECOPY, EGEMV,     
     +               EGSUM2D, ELASET, ETRMV, INFOG2L,                   
     + PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PELARZT', -INFO )
...
*
            ITMP0 = ITMP0 + 1
            IF( NQ.GT.0 ) THEN
               CALL EGEMV( 'No transpose', ITMP0, NQ, -TAU( II ),       
...
*
               ...
               IW = IW + ITMP0
*
               CALL ETRMV( 'Lower', 'No transpose', 'Non-unit', ITMP0,  
