      SUBROUTINE ELAR1VA(N, B1, BN, LAMBDA, D, L, LD, LLD,             
...
*  =======
*
*  ELAR1VA computes the (scaled) r-th column of the inverse of
...
*           
*  GAPTOL   (input) REAL(KIND=10)
*           Tolerance that indicates when eigenvector entries are negligible
*           w.r.t. their contribution to the residual.
*
*  Z        (input/output) REAL(KIND=10) array, dimension (N)
...
*
*  ZTZ      (output) REAL(KIND=10)
*           The square of the 2-norm of Z.
*
*  MINGMA   (output) REAL(KIND=10)
...
*
*  NRMINV   (output) REAL(KIND=10)
*           NRMINV = 1/SQRT( ZTZ )
*
*  RESID    (output) REAL(KIND=10)
*           The residual of the FP vector.
*           RESID = ABS( MINGMA )/SQRT( ZTZ )
*
*  RQCORR   (output) REAL(KIND=10)
...
*     .. Local Scalars ..
     ...
     $                   NEG2, NX, R1, R2, TO
      REAL(KIND=10)            ABSZCUR, ABSZPREV, DMINUS, DPLUS, EPS,   
     +                          S, TMP, ZPREV
*     ..
*     .. External Functions ..
      LOGICAL EISNAN
