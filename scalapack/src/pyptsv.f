      SUBROUTINE PYPTSV( UPLO, N, NRHS, D, E, JA, DESCA, B, IB, DESCB,  
     +                  WORK, LWORK, INFO )
      IMPLICIT NONE
*
*
...
*  =======
*
*  PYPTSV solves a system of linear equations
*
...
*  the matrix into L L'.
*
*  See PYPTTRF and PYPTTRS for details.
*
*  =====================================================================
*
*  Arguments
...
*     .. External Subroutines ..
      EXTERNAL           PYPTTRF, PYPTTRS, PXERBLA
*     ..
...
*
      ...
      ELSE
         INFO = -( 5*100 + DTYPE_ )
         CALL PXERBLA( ICTXT,       'PYPTSV',       -INFO )
         RETURN
      ENDIF
*
...
*     Factor the matrix
*
      CALL PYPTTRF( N, D, E, JA, DESCA, WORK, MIN( LWORK, WS_FACTOR ),  
...
*
      CALL PYPTTRS( UPLO, N, NRHS, D, E, JA, DESCA, B, IB, DESCB, WORK, 
