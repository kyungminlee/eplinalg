      SUBROUTINE PEORMQR( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,  
...
*  =======
*
*  PEORMQR overwrites the general real M-by-N distributed matrix
...
*     .. External Subroutines ..
     ...
     +                PELARFT, PEORM2R, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEORMQR', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
     ...
     +  CALL PEORM2R( SIDE, TRANS, M, N, J1-JA, A, IA, JA, DESCA, TAU,  
...
*
         CALL PELARFT( 'Forward', 'Columnwise', NQ-J+JA, JB, A,         
...
*        Apply H or H'
*
         CALL PELARFB( SIDE, TRANS, 'Forward', 'Columnwise', MI, NI,    
...
*
     ...
     +  CALL PEORM2R( SIDE, TRANS, M, N, J2-JA, A, IA, JA, DESCA, TAU,  
     +                C, IC, JC, DESCC, WORK, LWORK, IINFO )
*
