      SUBROUTINE PEPTSV( N, NRHS, D, E, JA, DESCA, B, IB, DESCB, WORK,  
     +                  LWORK, INFO )
      IMPLICIT NONE
*
*
...
*  =======
*
*  PEPTSV solves a system of linear equations
*
...
*  the matrix into L L'.
*
*  See PEPTTRF and PEPTTRS for details.
*
*  =====================================================================
*
*  Arguments
...
*     .. External Subroutines ..
      EXTERNAL           PEPTTRF, PEPTTRS, PXERBLA
*     ..
...
*
      ...
      ELSE
         INFO = -( 5*100 + DTYPE_ )
         CALL PXERBLA( ICTXT,       'PEPTSV',       -INFO )
         RETURN
      ENDIF
*
...
*     Factor the matrix
*
      CALL PEPTTRF( N, D, E, JA, DESCA, WORK, MIN( LWORK, WS_FACTOR ),  
...
*
      CALL PEPTTRS( N, NRHS, D, E, JA, DESCA, B, IB, DESCB, WORK,       
