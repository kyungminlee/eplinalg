      SUBROUTINE PYGEQRF( M, N, A, IA, JA, DESCA, TAU, WORK, LWORK,     
     +                INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYGEQRF computes a QR factorization of a complex distributed M-by-N
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK1MAT, PYGEQR2,    
     +                PYLARFB, PYLARFT, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYGEQRF', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      CALL PYGEQR2( M, JB, A, IA, JA, DESCA, TAU, WORK, LWORK, IINFO )
*
...
*
         CALL PYLARFB( 'Left', 'Conjugate transpose', 'Forward',        
...
*        A(i:ia+m-1,j:j+jb-1)
*
         CALL PYGEQR2( M-J+JA, JB, A, I, J, DESCA, TAU, WORK, LWORK,    
     +              IINFO )
*
...
*
            CALL PYLARFT( 'Forward', 'Columnwise', M-J+JA, JB, A, I, J, 
