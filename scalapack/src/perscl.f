      SUBROUTINE PERSCL( N, SA, SX, IX, JX, DESCX, INCX )
      IMPLICIT NONE
*
...
*  =======
*
*  PERSCL multiplies an N-element real distributed vector sub( X ) by
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, PELABAD, PESCAL
*     ..
*     .. External Functions ..
...
*
      CALL PESCAL( N, MUL, SX, IX, JX, DESCX, INCX )
*
      IF( .NOT.DONE )
     $   GO TO 10
*
