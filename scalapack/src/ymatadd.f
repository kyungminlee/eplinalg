      SUBROUTINE YMATADD( M, N, ALPHA, A, LDA, BETA, C, LDC )
      IMPLICIT NONE
*
...
*  =======
*
*  YMATADD performs the following local matrix-matrix operation
*
*               C := alpha * A + beta * C,
*
...
*          The scalar BETA.
*
*  C       (local input/local output) COMPLEX(KIND=10)
