      SUBROUTINE EDBTF2( M, N, KL, KU, AB, LDAB, INFO )
      IMPLICIT NONE
*
...
*
*  AB      (input/output) REAL(KIND=10)   array, dimension (LDAB,N)
...
*              Compute multipliers.
*
               CALL ESCAL( KM, ONE / AB( KU+1, J ), AB( KU+2, J ), 1 )
*
*              Update trailing submatrix within the band.
*
               IF( JU.GT.J ) THEN
                  CALL EGER( KM, JU-J, -ONE, AB( KU+2, J ), 1,          
