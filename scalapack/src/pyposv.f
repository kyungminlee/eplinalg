      SUBROUTINE PYPOSV( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB, JB,    
     +                DESCB, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYPOSV computes the solution to a complex system of linear equations
*
*                        sub( A ) * X = sub( B ),
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK2MAT, PYPOTRF,    
     +                PYPOTRS, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYPOSV', -INFO )
         RETURN
      END IF
*
*     Compute the Cholesky factorization sub( A ) = U'*U or L*L'.
*
      CALL PYPOTRF( UPLO, N, A, IA, JA, DESCA, INFO )
*
      IF( INFO.EQ.0 ) THEN
*
...
*        with X.
*
         CALL PYPOTRS( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB, JB,      
     +            DESCB, INFO )
*
      END IF
*
