      SUBROUTINE PEDTSV( N, NRHS, DL, D, DU, JA, DESCA, B, IB, DESCB,   
     +                 WORK, LWORK, INFO )
      IMPLICIT NONE
*
*
...
*  =======
*
*  PEDTSV solves a system of linear equations
*
...
*
*  See PEDTTRF and PEDTTRS for details.
*
*  =====================================================================
*
*  Arguments
...
*     .. External Subroutines ..
      EXTERNAL           PEDTTRF, PEDTTRS, PXERBLA
*     ..
...
*
      ...
      ELSE
         INFO = -( 6*100 + DTYPE_ )
         CALL PXERBLA( ICTXT,       'PEDTSV',       -INFO )
         RETURN
      ENDIF
*
...
*     Factor the matrix
*
      CALL PEDTTRF( N, DL, D, DU, JA, DESCA, WORK,               MIN( 
     +LWORK, WS_FACTOR ), WORK( 1+WS_FACTOR ),               
...
*
      CALL PEDTTRS( 'N', N, NRHS, DL, D, DU, JA, DESCA, B, IB, DESCB,   
     +            WORK, MIN( LWORK, WS_FACTOR ), WORK( 1+WS_FACTOR),    
     +           LWORK-WS_FACTOR, INFO )
*
*     Check info for error conditions
*
