      SUBROUTINE PELATRZ( M, N, L, A, IA, JA, DESCA, TAU, WORK )
      IMPLICIT NONE
*
...
*  =======
*
*  PELATRZ reduces the M-by-N ( M<=N ) real upper trapezoidal matrix
...
*     .. External Subroutines ..
      EXTERNAL           INFOG1L, PEELSET, PELARFG, PELARZ
*     ..
*     .. External Functions ..
      INTEGER            NUMROC
      EXTERNAL           NUMROC
...
*           [ A(i, j) A(i,j1:ja+n-1) ]
*
            CALL PELARFG( L+1, AII, I, J, A, I, J1, DESCA, DESCA( M_ ), 
     +                         TAU )
*
*           Apply H(i) to A(ia:i-1,j:ja+n-1) from the right
*
            CALL PELARZ( 'Right', I-IA, JA+N-J, L, A, I, J1, DESCA,     
