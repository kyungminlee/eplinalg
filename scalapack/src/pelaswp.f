      SUBROUTINE PELASWP( DIREC, ROWCOL, N, A, IA, JA, DESCA, K1, K2,   
     +                  IPIV )
      IMPLICIT NONE
*
...
*  ========
*
*  PELASWP performs a series of row or column interchanges on
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, INFOG2L, PESWAP
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      EXTERNAL           LSAME
...
*
     ...
     $                    IIA, JJA, ICURROW, ICURCOL )
            DO 10 I = K1, K2
               IP = IPIV( IIA+I-K1 )
               IF( IP.NE.I )             CALL PESWAP( N, A, I, JA, 
     +DESCA, DESCA( M_ ), A, IP,                          JA, DESCA, 
     +DESCA( M_ ) )
   10       CONTINUE
         ELSE
            CALL INFOG2L( K1, JA, DESCA, NPROW, NPCOL, MYROW, MYCOL,
   ...
   20       CONTINUE
     ...
     $                    IIA, JJA, ICURROW, ICURCOL )
            DO 30 J = K1, K2
               JP = IPIV( JJA+J-K1 )
               IF( JP.NE.J )             CALL PESWAP( N, A, IA, J, 
     +DESCA, 1, A, IA, JP,                          DESCA, 1 )
   30       CONTINUE
         ELSE
            CALL INFOG2L( IA, K1, DESCA, NPROW, NPCOL, MYROW, MYCOL,
     $                    IIA, JJA, ICURROW, ICURCOL )
