      SUBROUTINE PEPBSV( UPLO, N, BW, NRHS, A, JA, DESCA, B, IB, DESCB, 
     +                   WORK, LWORK, INFO )
      IMPLICIT NONE
*
*
...
*  =======
*
*  PEPBSV solves a system of linear equations
*
...
*  the matrix into L L'.
*
*  See PEPBTRF and PEPBTRS for details.
*
*  =====================================================================
*
*  Arguments
...
*     .. External Subroutines ..
      EXTERNAL           PEPBTRF, PEPBTRS, PXERBLA
*     ..
...
*
      ...
      ELSE
         INFO = -( 6*100 + DTYPE_ )
         CALL PXERBLA( ICTXT,       'PEPBSV',       -INFO )
         RETURN
      ENDIF
*
...
*
      WS_FACTOR = (NB+2*BW)*BW
*
*     Factor the matrix
*
      CALL PEPBTRF( UPLO, N, BW, A, JA, DESCA, WORK,               MIN( 
...
*
      CALL PEPBTRS( UPLO, N, BW, NRHS, A, JA, DESCA, B, IB, DESCB, WORK,
