      SUBROUTINE PYUNMR3( SIDE, TRANS, M, N, K, L, A, IA, JA, DESCA,    
...
*  =======
*
*  PYUNMR3 overwrites the general complex M-by-N distributed matrix
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_ABORT, BLACS_GRIDINFO, CHK1MAT, PYLARZ,  
     +                  PYLARZC, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYUNMR3', -INFO )
...
*
         IF( NOTRAN ) THEN
            CALL PYLARZ( SIDE, MI, NI, L, A, I, JAA, DESCA, DESCA( M_ ),
     +                    TAU, C, ICC, JCC, DESCC, WORK )
         ELSE
            CALL PYLARZC( SIDE, MI, NI, L, A, I, JAA, DESCA,            
