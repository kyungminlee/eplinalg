      SUBROUTINE PYGELQ2( M, N, A, IA, JA, DESCA, TAU, WORK, LWORK,     
     +                INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYGELQ2 computes a LQ factorization of a complex distributed M-by-N
...
*     .. External Subroutines ..
     ...
     +                   PYLACGV, PYLARF, PYLARFG, PB_TOPGET,           
     +         PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYGELQ2', -INFO )
...
*        A(i,j+1:ja+n-1)
*
         CALL PYLACGV( N-J+JA, A, I, J, DESCA, DESCA( M_ ) )
         CALL PYLARFG( N-J+JA, AII, I, J, A, I, MIN( J+1, JA+N-1 ),     
     +             DESCA, DESCA( M_ ), TAU )
*
         IF( I.LT.IA+M-1 ) THEN
*
...
*
            ...
            CALL PYLARF( 'Right', M-I+IA-1, N-J+JA, A, I, J, DESCA,     
     +               DESCA( M_ ), TAU, A, I+1, J, DESCA, WORK )
         END IF
         CALL PYELSET( A, I, J, DESCA, AII )
         CALL PYLACGV( N-J+JA, A, I, J, DESCA, DESCA( M_ ) )
*
   10 CONTINUE
*
