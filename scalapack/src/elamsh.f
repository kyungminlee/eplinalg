      SUBROUTINE ELAMSH ( S, LDS, NBULGE, JBLK, H, LDH, N, ULP )
      IMPLICIT NONE
*
...
*     ..
*     .. Array Arguments ..
      REAL(KIND=10)   S(LDS,*), H(LDH,*)
*     ..
*
*  Purpose
*  =======
*
*  ELAMSH sends multiple shifts through a small (single node) matrix to
...
*  ELAMSH should only be called when there are multiple shifts/bulges 
...
*  =========
*
*  S       (local input/output) REAL(KIND=10) array, (LDS,*)
...
*          Unchanged on exit.
*
*  H       (local input/output) REAL(KIND=10) array (LDH,N)
...
*
*     .. Parameters ..
      REAL(KIND=10) ZERO, TEN
      PARAMETER ( ZERO = 0.0E0_10, TEN = 10.0E0_10 )
*     ..
*     .. Local Scalars ..
      INTEGER          K, IBULGE, M, NR, J, IVAL, I
      REAL(KIND=10) H44, H33, H43H34, H11, H22, H21, H12, H44S,         
