      SUBROUTINE PYUNGR2( M, N, K, A, IA, JA, DESCA, TAU, WORK, LWORK,  
     +                   INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYUNGR2 generates an M-by-N complex distributed matrix Q denoting
...
*          returned by PYGERQF in the K rows of its distributed
...
*
*  TAU     (local input) COMPLEX, array, dimension LOCr(IA+M-1)
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_ABORT, BLACS_GRIDINFO, CHK1MAT, PYELSET, 
     +                   PYLACGV, PYLARFC, PYLASET, PYSCAL,             
...
*
      ...
      END IF
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYUNGR2', -INFO )
...
*
         CALL PYLASET( 'All', M-K, N-M, ZERO, ZERO, A, IA, JA, DESCA )
         CALL PYLASET( 'All', M-K, M, ZERO, ONE, A, IA, JA+N-M, DESCA )
*
      END IF
*
      TAUI = ZERO
...
*
*        Apply H(i)' to A(ia:i,ja:ja+n-m+i-ia) from the right
*
         CALL PYLACGV( I-IA+N-M, A, I, JA, DESCA, DESCA( M_ ) )
         CALL PYELSET( A, I, JA+N-M+I-IA, DESCA, ONE )
         CALL PYLARFC( 'Right', I-IA, I-IA+N-M+1, A, I, JA, DESCA,      
     ...
     $                    NPROW )
         IF( MYROW.EQ.IAROW )
     $      TAUI = TAU( MIN( II, MP ) )
         CALL PYSCAL( I-IA+N-M, -TAUI, A, I, JA, DESCA, DESCA( M_ ) )
         CALL PYLACGV( I-IA+N-M, A, I, JA, DESCA, DESCA( M_ ) )
         CALL PYELSET( A, I, JA+N-M+I-IA, DESCA, ONE-CONJG( TAUI ) )
*
*        Set A(i,ja+n-m+i-ia+1:ja+n-1) to zero
*
         CALL PYLASET( 'All', 1, IA+M-1-I, ZERO, ZERO, A, I,            
     +      JA+N-M+I-IA+1, DESCA )
*
   10 CONTINUE
*
