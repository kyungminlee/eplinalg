      SUBROUTINE ELARRE2( RANGE, N, VL, VU, IL, IU, D, E, E2,           
     +          RTOL1, RTOL2, SPLTOL, NSPLIT, ISPLIT,                   
     +   M, DOL, DOU,                       W, WERR, WGAP, IBLOCK, 
...
*  tridiagonal matrix T, ELARRE2 sets, via ELARRA, 
...
*  ESTEGR2 to compute the eigenvectors  T.
*
*  ELARRE2 is more suitable for parallel computation than the 
...
*  matrix splits into blocks, ELARRE2
...
*
*  VL      (input/output) REAL(KIND=10)
*  VU      (input/output) REAL(KIND=10)
*          If RANGE='V', the lower and upper bounds for the eigenvalues.
*          Eigenvalues less than or equal to VL, or greater than VU,
*          will not be returned.  VL < VU.
*          If RANGE='I' or ='A', ELARRE2 computes bounds on the desired 
...
*
*  E2      (input/output) REAL(KIND=10) array, dimension (N)
...
*          sorted in ascending order ( ELARRE2 may use the
...
*
*  WERR    (output) REAL(KIND=10) array, dimension (N)
...
*          when the eigenvalue computation is done in parallel.
*
*  WGAP    (output) REAL(KIND=10) array, dimension (N)
...
*
*  GERS    (output) REAL(KIND=10) array, dimension (2*N)
...
*
*  WORK    (workspace) REAL(KIND=10) array, dimension (6*N)
*          Workspace.
*
...
*  INFO    (output) INTEGER
*          = 0:  successful exit
*          > 0:  A problem occured in ELARRE2.
...
*        the eigenvalue approximations at the end of ELARRE2 or bisection.
