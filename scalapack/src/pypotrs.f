      SUBROUTINE PYPOTRS( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB, JB,   
     +                  DESCB, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYPOTRS solves a system of linear equations
*
*                      sub( A ) * X = sub( B )
...
*  factorization sub( A ) = U**H*U or L*L**H computed by PYPOTRF.
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK2MAT, PYTRSM,     
     +               PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYPOTRS', -INFO )
         RETURN
      END IF
*
...
*
     ...
     +    'Non-unit', N, NRHS, ONE, A, IA, JA, DESCA, B, IB,            
     +   JB, DESCB )
*
*        Solve U*X = sub( B ), overwriting sub( B ) with X.
*
...
*
         CALL PYTRSM( 'Left', 'Lower', 'No transpose', 'Non-unit', N,   
     +            NRHS, ONE, A, IA, JA, DESCA, B, IB, JB, DESCB )
*
*        Solve L'*X = sub( B ), overwriting sub( B ) with X.
*
