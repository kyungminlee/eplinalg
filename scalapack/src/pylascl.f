      SUBROUTINE PYLASCL( TYPE, CFROM, CTO, M, N, A, IA, JA, DESCA,     
     +                INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYLASCL multiplies the M-by-N complex distributed matrix sub( A )
...
*
*  CFROM   (global input) REAL(KIND=10)
*  CTO     (global input) REAL(KIND=10)
...
*     .. External Functions ..
      ...
      EXTERNAL           EISNAN, ICEIL, LSAME, NUMROC, PELAMCH
*     ..
*     .. Intrinsic Functions ..
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYLASCL', -INFO )
         RETURN
      END IF
*
