      SUBROUTINE PYUNMHR( SIDE, TRANS, M, N, ILO, IHI, A, IA, JA, DESCA,
...
*  =======
*
*  PYUNMHR overwrites the general complex M-by-N distributed matrix
...
*  product of IHI-ILO elementary reflectors, as returned by PYGEHRD:
*
...
*          of PYGEHRD. Q is equal to the unit matrix except in the
...
*          define the elementary reflectors, as returned by PYGEHRD.
*
...
*          reflectors H(j) as returned by PYGEHRD. TAU is tied to
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK2MAT, PYUNMQR,    
     +                PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYUNMHR', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
     ...
     $   RETURN
*
      CALL PYUNMQR( SIDE, TRANS, MI, NI, NH, A, IAA, JAA, DESCA, TAU,   
