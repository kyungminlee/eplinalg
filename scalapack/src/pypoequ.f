      SUBROUTINE PYPOEQU( N, A, IA, JA, DESCA, SR, SC, SCOND, AMAX,     
     +                INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYPOEQU computes row and column scalings intended to
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYPOEQU', -INFO )
         RETURN
      END IF
*
