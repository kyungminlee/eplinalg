      SUBROUTINE PELAQSY( UPLO, N, A, IA, JA, DESCA, SR, SC, SCOND,     
     +                AMAX, EQUED )
      IMPLICIT NONE
*
...
*  =======
*
*  PELAQSY equilibrates a symmetric distributed matrix
...
*
*  A       (input/output) REAL(KIND=10) pointer into the local
...
*
*  SR      (local input) REAL(KIND=10) array, dimension LOCr(M_A)
...
*
*  SC      (local input) REAL(KIND=10) array, dimension LOCc(N_A)
...
*
*  SCOND   (global input) REAL(KIND=10)
...
*     .. External Functions ..
      ...
      EXTERNAL           ICEIL, LSAME, NUMROC, PELAMCH
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MIN, MOD
*     ..
