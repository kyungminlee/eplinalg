      SUBROUTINE PYGELQF( M, N, A, IA, JA, DESCA, TAU, WORK, LWORK,     
     +                INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYGELQF computes a LQ factorization of a complex distributed M-by-N
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK1MAT, PYGELQ2,    
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYGELQF', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      CALL PYGELQ2( IB, N, A, IA, JA, DESCA, TAU, WORK, LWORK, IINFO )
*
...
*
         CALL PYLARFB( 'Right', 'No transpose', 'Forward', 'Rowwise',   
...
*        A(i:i+ib-1:j:ja+n-1)
*
         CALL PYGELQ2( IB, N-I+IA, A, I, J, DESCA, TAU, WORK, LWORK,    
     +              IINFO )
*
