      SUBROUTINE PYDBSV( N, BWL, BWU, NRHS, A, JA, DESCA, B, IB, DESCB, 
     +                   WORK, LWORK, INFO )
      IMPLICIT NONE
*
*
...
*  =======
*
*  PYDBSV solves a system of linear equations
*
...
*
*  See PYDBTRF and PYDBTRS for details.
*
*  =====================================================================
*
*  Arguments
...
*     .. External Subroutines ..
      EXTERNAL           PYDBTRF, PYDBTRS, PXERBLA
*     ..
...
*
      ...
      ELSE
         INFO = -( 6*100 + DTYPE_ )
         CALL PXERBLA( ICTXT,       'PYDBSV',       -INFO )
         RETURN
      ENDIF
*
...
*     Factor the matrix
*
      CALL PYDBTRF( N, BWL, BWU, A, JA, DESCA, WORK,               MIN( 
...
*
      CALL PYDBTRS( 'N', N, BWL, BWU, NRHS, A, JA, DESCA, B, IB, DESCB, 
