      SUBROUTINE PYUNML2( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,  
...
*  =======
*
*  PYUNML2 overwrites the general complex M-by-N distributed matrix
...
*        Q = H(k)' . . . H(2)' H(1)'
*
*  as returned by PYGELQF. Q is of order M if SIDE = 'L' and of order N
*  if SIDE = 'R'.
*
*  Notes
*  =====
...
*          H(i), IA <= i <= IA+K-1, as returned by PYGELQF in the
...
*     .. External Subroutines ..
     ...
     +                   PYELSET2, PYLACGV, PYLARF, PYLARFC,            
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYUNML2', -INFO )
...
*        Apply H(i) or H(i)'
*
         IF( I-IA+1.LT.NQ )       CALL PYLACGV( NQ-I+IA-1, A, I, 
     +JA+I-IA+1, DESCA,                     DESCA( M_ ) )
         CALL PYELSET2( AII, A, I, JA+I-IA, DESCA, ONE )
         IF( NOTRAN ) THEN
            CALL PYLARFC( SIDE, MI, NI, A, I, JA+I-IA, DESCA,           
     +          DESCA( M_ ), TAU, C, ICC, JCC, DESCC, WORK )
         ELSE
            CALL PYLARF( SIDE, MI, NI, A, I, JA+I-IA, DESCA,            
     +        DESCA( M_ ), TAU, C, ICC, JCC, DESCC, WORK )
         END IF
         CALL PYELSET( A, I, JA+I-IA, DESCA, AII )
         IF( I-IA+1.LT.NQ )       CALL PYLACGV( NQ-I+IA-1, A, I, 
     +JA+I-IA+1, DESCA,                     DESCA( M_ ) )
*
   10 CONTINUE
