      SUBROUTINE PYTRTRI( UPLO, DIAG, N, A, IA, JA, DESCA, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYTRTRI computes the inverse of a upper or lower triangular
...
*     .. External Subroutines ..
     ...
     +               PCHK1MAT, PYTRTI2, PYTRMM, PYTRSM,                 
     +   PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYTRTRI', -INFO )
         RETURN
      END IF
*
...
*
         CALL PYTRTI2( UPLO, DIAG, JB, A, IA, JA, DESCA, INFO )
*
...
*
            CALL PYTRMM( 'Left', UPLO, 'No transpose', DIAG, J-JA, JB,  
     +                  ONE, A, IA, JA, DESCA, A, IA, J, DESCA )
            CALL PYTRSM( 'Right', UPLO, 'No transpose', DIAG, J-JA,     
     +               JB, -ONE, A, I, J, DESCA, A, IA, J, DESCA )
*
*           Compute inverse of current diagonal block
*
            CALL PYTRTI2( UPLO, DIAG, JB, A, I, J, DESCA, INFO )
*
   40    CONTINUE
*
      ELSE
...
*
               CALL PYTRMM( 'Left', UPLO, 'No transpose', DIAG,         
     +              JA+N-J-JB, JB, ONE, A, I+JB, J+JB, DESCA,           
     +            A, I+JB, J, DESCA )
               CALL PYTRSM( 'Right', UPLO, 'No transpose', DIAG,        
...
*
            CALL PYTRMM( 'Left', UPLO, 'No transpose', DIAG, N-JB, JB,  
     +                  ONE, A, IA+JB, JA+JB, DESCA, A, IA+JB, JA,      
     +              DESCA )
            CALL PYTRSM( 'Right', UPLO, 'No transpose', DIAG, N-JB, JB, 
