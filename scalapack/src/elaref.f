      SUBROUTINE ELAREF( TYPE, A, LDA, WANTZ, Z, LDZ, BLOCK, IROW1,     
...
*     .. Scalar Arguments ..
     ...
     $                   LDZ, LIHIZ, LILOZ
      REAL(KIND=10)   T1, T2, T3, V2, V3
*     ..
*     .. Array Arguments ..
      REAL(KIND=10)   A( LDA, * ), VECS( * ), Z( LDZ, * )
*     ..
*
*  Purpose
*  =======
*
*  ELAREF applies one or several Householder reflectors of size 3
...
*          Unchanged on exit.
*
*  A       (global input/output) REAL(KIND=10) array, (LDA,*)
...
*
*  Z       (global input/output) REAL(KIND=10) array, (LDZ,*)
...
*              when WANTZ is set.
*
*  VECS    (global input) REAL(KIND=10) array of size 3*N (matrix
*                                                             size)
...
*  T1
*  T2
*  T3      (global input/output) REAL(KIND=10)
...
*     .. Local Scalars ..
      INTEGER            J, K
      REAL(KIND=10)   H11, H22, SUM, T12, T13, T22, T23, T32, T33,      
