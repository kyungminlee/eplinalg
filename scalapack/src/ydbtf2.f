      SUBROUTINE YDBTF2( M, N, KL, KU, AB, LDAB, INFO )
      IMPLICIT NONE
*
...
*
*  AB      (input/output) COMPLEX(KIND=10)         array, dimension (LDAB,N)
...
*              Compute multipliers.
*
               CALL YSCAL( KM, ONE / AB( KU+1, J ), AB( KU+2, J ), 1 )
*
*              Update trailing submatrix within the band.
*
               IF( JU.GT.J ) THEN
                  CALL YGERU( KM, JU-J, -CONE, AB( KU+2, J ), 1,        
