      SUBROUTINE PEORMLQ( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,  
...
*  =======
*
*  PEORMLQ overwrites the general real M-by-N distributed matrix
...
*        Q = H(k) . . . H(2) H(1)
*
*  as returned by PEGELQF. Q is of order M if SIDE = 'L' and of order N
*  if SIDE = 'R'.
*
*  Notes
*  =====
...
*          H(i), IA <= i <= IA+K-1, as returned by PEGELQF in the
...
*     .. External Subroutines ..
     ...
     +                PELARFT, PEORML2, PB_TOPGET, PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEORMLQ', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
     ...
     +  CALL PEORML2( SIDE, TRANS, M, N, I1-IA, A, IA, JA, DESCA, TAU,  
...
*
         CALL PELARFT( 'Forward', 'Rowwise', NQ-I+IA, IB, A, I, JA+I-IA,
...
*        Apply H or H'
*
         CALL PELARFB( SIDE, TRANST, 'Forward', 'Rowwise', MI, NI, IB,  
     +                A, I, JA+I-IA, DESCA, WORK, C, ICC, JCC, DESCC,   
     +               WORK( IPW ) )
   10 CONTINUE
*
      IF( ( LEFT .AND. .NOT.NOTRAN ) .OR. ( .NOT.LEFT .AND. NOTRAN ) )  
     +  CALL PEORML2( SIDE, TRANS, M, N, I2-IA, A, IA, JA, DESCA, TAU,  
     +                C, IC, JC, DESCC, WORK, LWORK, IINFO )
*
