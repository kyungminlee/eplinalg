      SUBROUTINE PYGBSV( N, BWL, BWU, NRHS, A, JA, DESCA, IPIV, B, IB,  
...
*  =======
*
*  PYGBSV solves a system of linear equations
*
...
*
*  See PYGBTRF and PYGBTRS for details.
*
*  =====================================================================
*
*  Arguments
...
*     .. External Subroutines ..
      EXTERNAL           PYGBTRF, PYGBTRS, PXERBLA
*     ..
...
*
      ...
      ELSE
         INFO = -( 6*100 + DTYPE_ )
         CALL PXERBLA( ICTXT,       'PYGBSV',       -INFO )
         RETURN
      ENDIF
*
...
*     Factor the matrix
*
      CALL PYGBTRF( N, BWL, BWU, A, JA, DESCA, IPIV, WORK,              
...
*
      CALL PYGBTRS( 'N', N, BWL, BWU, NRHS, A, JA, DESCA, IPIV, B, IB,  
