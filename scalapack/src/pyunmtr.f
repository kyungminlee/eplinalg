      SUBROUTINE PYUNMTR( SIDE, UPLO, TRANS, M, N, A, IA, JA, DESCA,    
...
*  =======
*
*  PYUNMTR overwrites the general complex M-by-N distributed matrix
...
*  product of nq-1 elementary reflectors, as returned by PYHETRD:
*
...
*          define the elementary reflectors, as returned by PYHETRD.
...
*          reflector H(i), as returned by PYHETRD. TAU is tied to the
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK2MAT, PYUNMQL,    
     +                PYUNMQR, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYUNMTR', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
      IF( UPPER ) THEN
*
*        Q was determined by a call to PYHETRD with UPLO = 'U'
*
         CALL PYUNMQL( SIDE, TRANS, MI, NI, NQ-1, A, IA, JAA, DESCA,    
     +              TAU, C, ICC, JCC, DESCC, WORK, LWORK, IINFO )
*
      ELSE
*
*        Q was determined by a call to PYHETRD with UPLO = 'L'
*
         CALL PYUNMQR( SIDE, TRANS, MI, NI, NQ-1, A, IAA, JAA, DESCA,   
     +               TAU, C, ICC, JCC, DESCC, WORK, LWORK, IINFO )
*
      END IF
*
