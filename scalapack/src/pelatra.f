      REAL(KIND=10)   FUNCTION PELATRA( N, A, IA, JA, DESCA )
      IMPLICIT NONE
*
...
*  =======
*
*  PELATRA computes the trace of an N-by-N distributed matrix sub( A )
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, EGSUM2D, INFOG2L
*     ..
*     .. External Functions ..
      INTEGER            ICEIL
      EXTERNAL           ICEIL
...
*
   ...
   30 CONTINUE
*
      CALL EGSUM2D( DESCA( CTXT_ ), 'All', ' ', 1, 1, TRACE, 1, -1,     
     +          MYCOL )
*
      PELATRA = TRACE
*
