      SUBROUTINE PYPOTRI( UPLO, N, A, IA, JA, DESCA, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYPOTRI computes the inverse of a complex Hermitian positive definite
...
*          sub( A ) = U**H*U or  L*L**H, as computed by PYPOTRF.
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK1MAT, PYLAUUM,    
     +                PYTRTRI, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYPOTRI', -INFO )
         RETURN
      END IF
*
...
*
      CALL PYTRTRI( UPLO, 'Non-unit', N, A, IA, JA, DESCA, INFO )
*
      IF( INFO.GT.0 )
     $   RETURN
*
...
*
      CALL PYLAUUM( UPLO, N, A, IA, JA, DESCA )
*
      RETURN
*
*     End of PYPOTRI
