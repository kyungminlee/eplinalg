      SUBROUTINE PYHETRD( UPLO, N, A, IA, JA, DESCA, D, E, TAU, WORK,   
     +                  LWORK, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PYHETRD reduces a complex Hermitian matrix sub( A ) to Hermitian
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, DESCSET, PYHER2K,     
     +               PYHETD2, PCHK1MAT, PYLATRD, PB_TOPGET,             
     +       PB_TOPSET, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYHETRD', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*           the matrix
*
            CALL PYLATRD( UPLO, K+JB-1, JB, A, IA, JA, DESCA, D, E, TAU,
...
*
            CALL PYHER2K( UPLO, 'No transpose', K-1, JB, -CONE, A, IA,  
...
*
            ...
            CALL PYELSET( A, I-1, J, DESCA, CMPLX( E( JX ) , KIND=10) )
*
...
*
            CALL PYHER2K( UPLO, 'No transpose', N-K-NB+1, NB, -CONE, A, 
...
*        Use unblocked code to reduce the last or only block
*
         CALL PYHETD2( UPLO, KK, A, IA+K-1, JA+K-1, DESCA, D, E,        
     +          TAU, WORK, LWORK, IINFO )
      END IF
*
