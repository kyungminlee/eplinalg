      SUBROUTINE PEFILLPAD( ICTXT, M, N, A, LDA, IPRE, IPOST, CHKVAL )
      IMPLICIT NONE
*
...
*  =======
*
*  PEFILLPAD surrounds a two dimensional local array with a guard-
*  zone initialized to the value CHKVAL. The user may later call the
*  routine PECHEKPAD to discover if the guardzone has been
...
*
*  A       (local input/local output) REAL(KIND=10), array of
...
*
   ...
   10    CONTINUE
      ELSE
         WRITE( *, FMT = * ) 'WARNING no pre-guardzone in PEFILLPAD'
      END IF
*
...
*
   ...
   20    CONTINUE
      ELSE
         WRITE( *, FMT = * ) 'WARNING no post-guardzone in PEFILLPAD'
      END IF
*
