      SUBROUTINE PELASMSUB( A, DESCA, I, L, K, SMLNUM, BUF, LWORK )
      IMPLICIT NONE
*
...
*  =======
*
*  PELASMSUB looks for a small subdiagonal element from the bottom
...
*
*  SMLNUM  (global input) REAL(KIND=10)
...
*           IF( TST1.EQ.ZERO )
*    $         TST1 = ELANHS( '1', I-L+1, H( L, L ), LDH, WORK )
...
*     .. Local Scalars ..
     ...
     $                   MYCOL, MYROW, NPCOL, NPROW, NUM, RIGHT, UP
      REAL(KIND=10)   H10, H11, H22, TST1, ULP
*     ..
*     .. External Functions ..
      INTEGER            ILCM, NUMROC
...
*
     ...
     +               RIGHT )
      END IF
      IF( IBUF2.GT.0 ) THEN
         CALL EGESD2D( CONTXT, IBUF2, 1, BUF( ISTR2+1 ), IBUF2, MYROW,  
     +                RIGHT )
      END IF
*
...
*
     ...
     +             LEFT )
      END IF
      IF( IRCV2.GT.0 ) THEN
         CALL EGERV2D( CONTXT, IRCV2, 1, BUF( ISTR2+1 ), IRCV2, MYROW,  
     +                LEFT )
      END IF
*
*     START MAIN LOOP
