...
*
*      NB = ILAENV( 1, 'ETRTRI', UPLO // DIAG, N, -1, -1, -1 )
...
*
      PILAENVX_EP = INT( REAL( MIN( N1, N2 ) , KIND=10)*1.6E0_10 )
      RETURN
*
  110 CONTINUE
*
...
*     PILAENVX_EP = 0
      ...
      IF( PILAENVX_EP.EQ.1 ) THEN
         PILAENVX_EP = IEEECK( 0, 0.0E0_10, 1.0E0_10 )
      END IF
      RETURN
*
  150 CONTINUE
...
*     PILAENVX_EP = 0
      PILAENVX_EP = 1
      IF( PILAENVX_EP.EQ.1 ) THEN
         PILAENVX_EP = IEEECK( 1, 0.0E0_10, 1.0E0_10 )
      END IF
      RETURN
*
  160 CONTINUE
