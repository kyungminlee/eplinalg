      SUBROUTINE PYLASWP( DIREC, ROWCOL, N, A, IA, JA, DESCA, K1, K2,   
     +                  IPIV )
      IMPLICIT NONE
*
...
*  ========
*
*  PYLASWP performs a series of row or column interchanges on
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, INFOG2L, PYSWAP
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      EXTERNAL           LSAME
...
*
     ...
     $                    IIA, JJA, ICURROW, ICURCOL )
            DO 10 I = K1, K2
               IP = IPIV( IIA+I-K1 )
               IF( IP.NE.I )             CALL PYSWAP( N, A, I, JA, 
   ...
   20       CONTINUE
     ...
     $                    IIA, JJA, ICURROW, ICURCOL )
            DO 30 J = K1, K2
               JP = IPIV( JJA+J-K1 )
               IF( JP.NE.J )             CALL PYSWAP( N, A, IA, J, 
