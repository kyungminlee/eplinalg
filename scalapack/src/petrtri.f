      SUBROUTINE PETRTRI( UPLO, DIAG, N, A, IA, JA, DESCA, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PETRTRI computes the inverse of a upper or lower triangular
...
*     .. External Subroutines ..
     ...
     +               PCHK1MAT, PETRTI2, PETRMM, PETRSM,                 
     +   PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PETRTRI', -INFO )
         RETURN
      END IF
*
...
*
         CALL PETRTI2( UPLO, DIAG, JB, A, IA, JA, DESCA, INFO )
*
...
*
            CALL PETRMM( 'Left', UPLO, 'No transpose', DIAG, J-JA, JB,  
     +                  ONE, A, IA, JA, DESCA, A, IA, J, DESCA )
            CALL PETRSM( 'Right', UPLO, 'No transpose', DIAG, J-JA,     
     +               JB, -ONE, A, I, J, DESCA, A, IA, J, DESCA )
*
*           Compute inverse of current diagonal block
*
            CALL PETRTI2( UPLO, DIAG, JB, A, I, J, DESCA, INFO )
*
   40    CONTINUE
*
      ELSE
...
*
               CALL PETRMM( 'Left', UPLO, 'No transpose', DIAG,         
     +              JA+N-J-JB, JB, ONE, A, I+JB, J+JB, DESCA,           
     +            A, I+JB, J, DESCA )
               CALL PETRSM( 'Right', UPLO, 'No transpose', DIAG,        
...
*
            CALL PETRMM( 'Left', UPLO, 'No transpose', DIAG, N-JB, JB,  
     +                  ONE, A, IA+JB, JA+JB, DESCA, A, IA+JB, JA,      
     +              DESCA )
            CALL PETRSM( 'Right', UPLO, 'No transpose', DIAG, N-JB, JB, 
