      SUBROUTINE PYPORFS( UPLO, N, NRHS, A, IA, JA, DESCA, AF, IAF, JAF,
...
*  =======
*
*  PYPORFS improves the computed solution to a system of linear
...
*     .. External Subroutines ..
     ...
     +               DESCSET, INFOG2L, PYAHEMV, PYAXPY, PCHK2MAT,       
     +             PYCOPY, PYHEMV, PYPOTRS, PYLACON,                    
     +PXERBLA, EGAMX2D
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                  IX, JX, DESCX, 19, 5, IDUM1, IDUM2, INFO )
      END IF
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYPORFS', -INFO )
         RETURN
      ELSE IF( LQUERY ) THEN
         RETURN
      END IF
...
*
     ...
     +             DESCW, 1 )
         CALL PYHEMV( UPLO, N, -ONE, A, IA, JA, DESCA, X, IX, JX+K,     
...
*
   ...
   30          CONTINUE
         ...
         END IF
*
         CALL PYAHEMV( UPLO, N, RONE, A, IA, JA, DESCA, X, IX, JX+K,    
...
*
            CALL PYPOTRS( UPLO, N, 1, AF, IAF, JAF, DESCAF,             
...
*
     ...
     +                  DESCW, 1 )
            CALL PYHEMV( UPLO, N, -ONE, A, IA, JA, DESCA, X, IX, J+K,   
     +                DESCX, 1, ONE, WORK( IPR ), IW, JW, DESCW, 1 )
*
*           Compute componentwise relative backward error from formula
*
...
*
  ...
  120             CONTINUE
            ...
            END IF
*
            CALL PYAHEMV( UPLO, N, RONE, A, IA, JA, DESCA, X, IX, J+K,  
