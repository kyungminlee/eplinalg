      SUBROUTINE PEPOSV( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB, JB,    
     +                DESCB, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PEPOSV computes the solution to a real system of linear equations
*
*                        sub( A ) * X = sub( B ),
*
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK2MAT, PEPOTRF,    
     +                PEPOTRS, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEPOSV', -INFO )
         RETURN
      END IF
*
*     Compute the Cholesky factorization sub( A ) = U'*U or L*L'.
*
      CALL PEPOTRF( UPLO, N, A, IA, JA, DESCA, INFO )
*
      IF( INFO.EQ.0 ) THEN
*
...
*        with X.
*
         CALL PEPOTRS( UPLO, N, NRHS, A, IA, JA, DESCA, B, IB, JB,      
     +            DESCB, INFO )
*
      END IF
*
