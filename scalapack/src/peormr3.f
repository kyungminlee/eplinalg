      SUBROUTINE PEORMR3( SIDE, TRANS, M, N, K, L, A, IA, JA, DESCA,    
...
*  =======
*
*  PEORMR3 overwrites the general real M-by-N distributed matrix
...
*     .. External Subroutines ..
      EXTERNAL           BLACS_ABORT, BLACS_GRIDINFO, CHK1MAT, PELARZ,  
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEORMR3', -INFO )
...
*        Apply H(i) or H(i)'
*
         CALL PELARZ( SIDE, MI, NI, L, A, I, JAA, DESCA, DESCA( M_ ),   
