      COMPLEX(KIND=10)            FUNCTION PYLATRA( N, A, IA, JA, DESCA 
     +)
      IMPLICIT NONE
*
...
*  =======
*
*  PYLATRA computes the trace of an N-by-N distributed matrix sub( A )
...
*     .. Local Scalars ..
     ...
     $                   LDA, LL, MYCOL, MYROW, NPCOL, NPROW
      COMPLEX(KIND=10)            TRACE
*     ..
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, YGSUM2D, INFOG2L
*     ..
*     .. External Functions ..
      INTEGER            ICEIL
      EXTERNAL           ICEIL
...
*
   ...
   30 CONTINUE
*
      CALL YGSUM2D( DESCA( CTXT_ ), 'All', ' ', 1, 1, TRACE, 1, -1,     
     +          MYCOL )
*
      PYLATRA = TRACE
*
