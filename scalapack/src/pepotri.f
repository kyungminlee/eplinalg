      SUBROUTINE PEPOTRI( UPLO, N, A, IA, JA, DESCA, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  PEPOTRI computes the inverse of a real symmetric positive definite
...
*          sub( A ) = U**T*U or  L*L**T, as computed by PEPOTRF.
...
*     .. Local Scalars ..
      LOGICAL            UPPER
      INTEGER            ICOFF, ICTXT, IROFF, MYCOL, MYROW, NPCOL, NPROW
*     ..
*     .. Local Arrays ..
      INTEGER            IDUM1( 1 ), IDUM2( 1 )
*     ..
*     .. External Subroutines ..
      EXTERNAL           BLACS_GRIDINFO, CHK1MAT, PCHK1MAT, PELAUUM,    
     +                PETRTRI, PXERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PEPOTRI', -INFO )
         RETURN
      END IF
*
...
*
      CALL PETRTRI( UPLO, 'Non-unit', N, A, IA, JA, DESCA, INFO )
*
      IF( INFO.GT.0 )
     $   RETURN
*
...
*
      CALL PELAUUM( UPLO, N, A, IA, JA, DESCA )
*
      RETURN
*
*     End of PEPOTRI
