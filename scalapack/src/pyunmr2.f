      SUBROUTINE PYUNMR2( SIDE, TRANS, M, N, K, A, IA, JA, DESCA, TAU,  
...
*  =======
*
*  PYUNMR2 overwrites the general complex M-by-N distributed matrix
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PYUNMR2', -INFO )
...
*        Apply H(i) or H(i)'
*
         CALL PYLACGV( NQ-K+I-IA, A, I, JA, DESCA, DESCA( M_ ) )
         CALL PYELSET2( AII, A, I, JA+NQ-K+I-IA, DESCA, ONE )
         IF( NOTRAN ) THEN
            CALL PYLARFC( SIDE, MI, NI, A, I, JA, DESCA, DESCA( M_ ),   
     +                  TAU, C, IC, JC, DESCC, WORK )
         ELSE
            CALL PYLARF( SIDE, MI, NI, A, I, JA, DESCA, DESCA( M_ ),    
     +                TAU, C, IC, JC, DESCC, WORK )
         END IF
         CALL PYELSET( A, I, JA+NQ-K+I-IA, DESCA, AII )
         CALL PYLACGV( NQ-K+I-IA, A, I, JA, DESCA, DESCA( M_ ) )
*
   10 CONTINUE
*
