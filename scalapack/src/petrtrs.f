...
*  =======
*
*  PETRTRS solves a triangular system of the form
*
...
*
      IF( INFO.NE.0 ) THEN
         CALL PXERBLA( ICTXT, 'PETRTRS', -INFO )
         RETURN
      END IF
*
...
*
      CALL PETRSM( 'Left', UPLO, TRANS, DIAG, N, NRHS, ONE, A, IA, JA,  
     +            DESCA, B, IB, JB, DESCB )
*
      RETURN
*
