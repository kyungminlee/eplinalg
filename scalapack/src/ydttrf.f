      SUBROUTINE YDTTRF( N, DL, D, DU, INFO )
      IMPLICIT NONE
*
...
*  =======
*
*  YDTTRF computes an LU factorization of a complex tridiagonal matrix A
